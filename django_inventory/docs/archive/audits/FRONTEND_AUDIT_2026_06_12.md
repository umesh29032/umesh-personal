...
> Superseded by / live truth: [UI_COMPONENTS.md](../../../UI_COMPONENTS.md) (money-family vocabulary) — Stage-1 + A-scope executed; B-scope backlog recorded in FRONTEND_CONSOLIDATION_REVIEW.
