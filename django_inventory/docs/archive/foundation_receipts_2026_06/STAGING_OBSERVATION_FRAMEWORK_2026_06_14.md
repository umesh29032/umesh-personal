> **ARCHIVED 2026-07-13** — 2026-06 foundation/pre-staging receipt; superseded by the current frozen architecture ([../../MANUFACTURING_V1_FREEZE.md](../../MANUFACTURING_V1_FREEZE.md)) + the locked-foundation pair. Kept for history (Phase-7 DOCCLEAN-D, D-OR-5).

---
id: staging-observation-framework-2026-06-14
type: receipt
status: active
owner: append-only
