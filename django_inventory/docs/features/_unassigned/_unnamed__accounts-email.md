---
id: url-card-unnamed-accounts-email
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:accounts-email
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/accounts/email/`
...
| Field | Value |
|---|---|
| URL name | `/accounts/email/` |
| Namespace | — (none) |
| Mount | `/accounts/email/` |
...
| Field | Value |
|---|---|
| View | `EmailManagementDisabledView` |
