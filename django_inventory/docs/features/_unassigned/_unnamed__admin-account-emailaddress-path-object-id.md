---
id: url-card-unnamed-admin-account-emailaddress-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-account-emailaddress-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/account/emailaddress/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/account/emailaddress/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/<path:object_id>/` |
