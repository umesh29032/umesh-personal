---
id: url-card-unnamed-admin-accounts-role-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-accounts-role-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/accounts/role/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/accounts/role/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/<path:object_id>/` |
