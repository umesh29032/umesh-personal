---
id: url-card-unnamed-admin-accounts-skill-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-accounts-skill-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/accounts/skill/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/accounts/skill/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/<path:object_id>/` |
