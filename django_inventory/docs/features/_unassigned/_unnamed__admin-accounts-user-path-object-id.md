---
id: url-card-unnamed-admin-accounts-user-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-accounts-user-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/accounts/user/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/accounts/user/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/<path:object_id>/` |
