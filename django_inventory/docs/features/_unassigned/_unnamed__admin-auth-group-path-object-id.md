---
id: url-card-unnamed-admin-auth-group-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-auth-group-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/auth/group/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/auth/group/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/auth/group/<path:object_id>/` |
