---
id: url-card-unnamed-admin-expense-addasettlement-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-expense-addasettlement-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/expense/addasettlement/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/expense/addasettlement/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/<path:object_id>/` |
