---
id: url-card-unnamed-admin-expense-expensegenerationrecord-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-expense-expensegenerationrecord-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/expense/expensegenerationrecord/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/expense/expensegenerationrecord/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensegenerationrecord/<path:object_id>/` |
