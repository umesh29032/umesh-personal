---
id: url-card-unnamed-admin-expense-expensetemplate-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-expense-expensetemplate-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/expense/expensetemplate/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/expense/expensetemplate/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplate/<path:object_id>/` |
