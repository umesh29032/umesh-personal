---
id: url-card-unnamed-admin-expense-workerledgerentry-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-expense-workerledgerentry-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/expense/workerledgerentry/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/expense/workerledgerentry/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerledgerentry/<path:object_id>/` |
