---
id: url-card-unnamed-admin-expense-workerpaybasisaudit-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-expense-workerpaybasisaudit-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/expense/workerpaybasisaudit/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/expense/workerpaybasisaudit/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerpaybasisaudit/<path:object_id>/` |
