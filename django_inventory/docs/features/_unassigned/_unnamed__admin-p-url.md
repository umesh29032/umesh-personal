---
id: url-card-unnamed-admin-p-url
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-p-url
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/(?P<url>.*)$`
...
| Field | Value |
|---|---|
| View | `AdminSite.catch_all_view` |
| Module | `django.contrib.admin.sites` |
| Defined in | `/admin/(?P<url>.*)$` |
| Vendor | true |
