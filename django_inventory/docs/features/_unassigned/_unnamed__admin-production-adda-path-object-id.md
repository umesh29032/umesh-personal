---
id: url-card-unnamed-admin-production-adda-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-production-adda-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/production/adda/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/production/adda/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/<path:object_id>/` |
