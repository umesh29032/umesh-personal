---
id: url-card-unnamed-admin-production-cuttingpatternsizeallocation-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-production-cuttingpatternsizeallocation-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/production/cuttingpatternsizeallocation/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/production/cuttingpatternsizeallocation/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/<path:object_id>/` |
...
| Defined in | `/admin/account/emailaddress/<path:object_id>/` |
| Vendor | true |
