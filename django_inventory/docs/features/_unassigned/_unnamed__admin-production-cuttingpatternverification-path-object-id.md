---
id: url-card-unnamed-admin-production-cuttingpatternverification-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-production-cuttingpatternverification-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/production/cuttingpatternverification/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/production/cuttingpatternverification/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternverification/<path:object_id>/` |
