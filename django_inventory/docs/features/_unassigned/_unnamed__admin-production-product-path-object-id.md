---
id: url-card-unnamed-admin-production-product-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-production-product-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/production/product/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/production/product/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/production/product/<path:object_id>/` |
