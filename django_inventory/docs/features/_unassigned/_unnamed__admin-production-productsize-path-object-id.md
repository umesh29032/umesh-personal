---
id: url-card-unnamed-admin-production-productsize-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-production-productsize-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/production/productsize/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/production/productsize/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/<path:object_id>/` |
