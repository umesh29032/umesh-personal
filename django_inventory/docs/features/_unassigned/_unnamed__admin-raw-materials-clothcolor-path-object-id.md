---
id: url-card-unnamed-admin-raw-materials-clothcolor-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-raw-materials-clothcolor-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/raw_materials/clothcolor/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/raw_materials/clothcolor/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/<path:object_id>/` |
