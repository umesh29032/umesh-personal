---
id: url-card-unnamed-admin-raw-materials-clothroll-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-raw-materials-clothroll-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/raw_materials/clothroll/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/raw_materials/clothroll/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothroll/<path:object_id>/` |
