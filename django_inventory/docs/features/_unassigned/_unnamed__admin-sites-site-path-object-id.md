---
id: url-card-unnamed-admin-sites-site-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-sites-site-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/sites/site/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/sites/site/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/sites/site/<path:object_id>/` |
