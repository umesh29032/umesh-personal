---
id: url-card-unnamed-admin-socialaccount-socialtoken-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-socialaccount-socialtoken-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/socialaccount/socialtoken/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/socialaccount/socialtoken/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/<path:object_id>/` |
