---
id: url-card-unnamed-admin-storefront-footerlink-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-storefront-footerlink-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/storefront/footerlink/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/storefront/footerlink/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/storefront/footerlink/<path:object_id>/` |
