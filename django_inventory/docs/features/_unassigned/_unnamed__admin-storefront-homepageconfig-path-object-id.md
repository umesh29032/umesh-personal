---
id: url-card-unnamed-admin-storefront-homepageconfig-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-storefront-homepageconfig-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/storefront/homepageconfig/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/storefront/homepageconfig/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/<path:object_id>/` |
