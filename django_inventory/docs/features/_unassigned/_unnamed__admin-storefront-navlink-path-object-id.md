---
id: url-card-unnamed-admin-storefront-navlink-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-storefront-navlink-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/storefront/navlink/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/storefront/navlink/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/<path:object_id>/` |
