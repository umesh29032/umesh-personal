---
id: url-card-unnamed-admin-storefront-whyuscard-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-storefront-whyuscard-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/storefront/whyuscard/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/storefront/whyuscard/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/storefront/whyuscard/<path:object_id>/` |
