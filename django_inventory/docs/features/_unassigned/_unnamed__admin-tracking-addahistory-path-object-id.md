---
id: url-card-unnamed-admin-tracking-addahistory-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-tracking-addahistory-path-object-id
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `/admin/tracking/addahistory/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/tracking/addahistory/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/tracking/addahistory/<path:object_id>/` |
