---
id: url-card-unnamed-admin-tracking-clothrollhistory-path-object-id
type: url-card
status: generated
owner: generated
...
| Field | Value |
|---|---|
| URL name | `/admin/tracking/clothrollhistory/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/tracking/clothrollhistory/<path:object_id>/` |
