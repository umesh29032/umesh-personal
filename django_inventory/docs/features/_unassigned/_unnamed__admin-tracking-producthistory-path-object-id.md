---
id: url-card-unnamed-admin-tracking-producthistory-path-object-id
type: url-card
status: generated
owner: generated
scope: route — url:_unnamed:admin-tracking-producthistory-path-object-id
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `/admin/tracking/producthistory/<path:object_id>/`
...
| Field | Value |
|---|---|
| URL name | `/admin/tracking/producthistory/<path:object_id>/` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/<path:object_id>/` |
