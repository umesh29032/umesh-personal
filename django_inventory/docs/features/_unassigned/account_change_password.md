---
id: url-card-account-change-password
type: url-card
status: generated
owner: generated
scope: route — url:account_change_password
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_change_password`
...
| Namespace | — (none) |
| Mount | `/accounts/password/change/` |
...
| Defined in | `/accounts/password/change/` |
| Vendor | true |
