---
id: url-card-account-email-verification-sent
type: url-card
status: generated
owner: generated
scope: route — url:account_email_verification_sent
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_email_verification_sent`
...
| Field | Value |
|---|---|
| View | `EmailVerificationSentView` |
| Module | `allauth.account.views` |
| Defined in | `/accounts/confirm-email/` |
| Vendor | true |
