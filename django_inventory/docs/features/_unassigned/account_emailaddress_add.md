---
id: url-card-admin-account-emailaddress-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:account_emailaddress_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_emailaddress_add`
...
| Field | Value |
|---|---|
| URL name | `account_emailaddress_add` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/add/` |
| Pattern | `add/` |
| Named | true |
