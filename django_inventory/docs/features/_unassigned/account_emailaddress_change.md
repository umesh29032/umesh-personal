---
id: url-card-admin-account-emailaddress-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:account_emailaddress_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_emailaddress_change`
...
| Field | Value |
|---|---|
| URL name | `account_emailaddress_change` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/<path:object_id>/change/` |
