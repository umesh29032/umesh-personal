---
id: url-card-admin-account-emailaddress-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:account_emailaddress_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_emailaddress_changelist`
...
| Field | Value |
|---|---|
| URL name | `account_emailaddress_changelist` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/` |
