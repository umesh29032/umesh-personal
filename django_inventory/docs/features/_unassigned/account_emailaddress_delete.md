---
id: url-card-admin-account-emailaddress-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:account_emailaddress_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_emailaddress_delete`
...
| Field | Value |
|---|---|
| URL name | `account_emailaddress_delete` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/<path:object_id>/delete/` |
