---
id: url-card-admin-account-emailaddress-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:account_emailaddress_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_emailaddress_history`
...
| Field | Value |
|---|---|
| URL name | `account_emailaddress_history` |
| Namespace | `admin` |
| Mount | `/admin/account/emailaddress/<path:object_id>/history/` |
