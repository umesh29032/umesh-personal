---
id: url-card-account-inactive
type: url-card
status: generated
owner: generated
scope: route — url:account_inactive
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_inactive`
...
| Field | Value |
|---|---|
| URL name | `account_inactive` |
| Namespace | — (none) |
| Mount | `/accounts/inactive/` |
| Pattern | `inactive/` |
| Named | true |
