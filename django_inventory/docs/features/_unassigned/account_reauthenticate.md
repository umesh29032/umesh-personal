---
id: url-card-account-reauthenticate
type: url-card
status: generated
owner: generated
scope: route — url:account_reauthenticate
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `account_reauthenticate`
...
| Field | Value |
|---|---|
| URL name | `account_reauthenticate` |
| Namespace | — (none) |
| Mount | `/accounts/reauthenticate/` |
...
| Field | Value |
|---|---|
| View | `ReauthenticateView` |
| Module | `allauth.account.views` |
| Defined in | `/accounts/reauthenticate/` |
| Vendor | true |
