---
id: url-card-account-reset-password
type: url-card
status: generated
owner: generated
scope: route — url:account_reset_password
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_reset_password`
...
| Defined in | `/accounts/password/reset/` |
| Vendor | true |
