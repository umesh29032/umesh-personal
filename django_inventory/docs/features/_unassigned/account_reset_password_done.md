---
id: url-card-account-reset-password-done
type: url-card
status: generated
owner: generated
scope: route — url:account_reset_password_done
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_reset_password_done`
...
| Field | Value |
|---|---|
| URL name | `account_reset_password_done` |
| Namespace | — (none) |
| Mount | `/accounts/password/reset/done/` |
| Pattern | `password/reset/done/` |
| Named | true |
...
| Defined in | `/accounts/password/reset/done/` |
| Vendor | true |
