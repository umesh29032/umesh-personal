---
id: url-card-account-reset-password-from-key-done
type: url-card
status: generated
owner: generated
scope: route — url:account_reset_password_from_key_done
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_reset_password_from_key_done`
...
| Field | Value |
|---|---|
| URL name | `account_reset_password_from_key_done` |
| Namespace | — (none) |
| Mount | `/accounts/password/reset/key/done/` |
| Pattern | `password/reset/key/done/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `PasswordResetFromKeyDoneView` |
| Module | `allauth.account.views` |
| Defined in | `/accounts/password/reset/key/done/` |
| Vendor | true |
