---
id: url-card-account-set-password
type: url-card
status: generated
owner: generated
scope: route — url:account_set_password
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `account_set_password`
...
| Field | Value |
|---|---|
| URL name | `account_set_password` |
| Namespace | — (none) |
| Mount | `/accounts/password/set/` |
...
| Defined in | `/accounts/password/set/` |
| Vendor | true |
