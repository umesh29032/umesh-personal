---
id: url-card-admin-accounts-role-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_role_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_role_add`
...
| Field | Value |
|---|---|
| URL name | `accounts_role_add` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/add/` |
| Pattern | `add/` |
| Named | true |
