---
id: url-card-admin-accounts-role-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_role_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_role_change`
...
| Field | Value |
|---|---|
| URL name | `accounts_role_change` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/<path:object_id>/change/` |
