---
id: url-card-admin-accounts-role-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_role_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_role_changelist`
...
| Field | Value |
|---|---|
| URL name | `accounts_role_changelist` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/` |
