---
id: url-card-admin-accounts-role-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_role_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_role_delete`
...
| Field | Value |
|---|---|
| URL name | `accounts_role_delete` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/<path:object_id>/delete/` |
