---
id: url-card-admin-accounts-role-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_role_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_role_history`
...
| Field | Value |
|---|---|
| URL name | `accounts_role_history` |
| Namespace | `admin` |
| Mount | `/admin/accounts/role/<path:object_id>/history/` |
