---
id: url-card-admin-accounts-skill-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_skill_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_skill_add`
...
| Field | Value |
|---|---|
| URL name | `accounts_skill_add` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/add/` |
| Pattern | `add/` |
| Named | true |
