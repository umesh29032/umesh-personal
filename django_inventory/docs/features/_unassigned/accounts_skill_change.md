---
id: url-card-admin-accounts-skill-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_skill_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_skill_change`
...
| Field | Value |
|---|---|
| URL name | `accounts_skill_change` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/<path:object_id>/change/` |
