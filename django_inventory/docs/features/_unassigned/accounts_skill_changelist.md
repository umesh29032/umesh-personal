---
id: url-card-admin-accounts-skill-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_skill_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_skill_changelist`
...
| Field | Value |
|---|---|
| URL name | `accounts_skill_changelist` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/` |
