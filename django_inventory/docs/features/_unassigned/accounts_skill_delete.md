---
id: url-card-admin-accounts-skill-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_skill_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_skill_delete`
...
| Field | Value |
|---|---|
| URL name | `accounts_skill_delete` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/<path:object_id>/delete/` |
