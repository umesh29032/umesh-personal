---
id: url-card-admin-accounts-skill-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_skill_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_skill_history`
...
| Field | Value |
|---|---|
| URL name | `accounts_skill_history` |
| Namespace | `admin` |
| Mount | `/admin/accounts/skill/<path:object_id>/history/` |
