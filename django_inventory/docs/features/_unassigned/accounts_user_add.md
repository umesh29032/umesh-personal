---
id: url-card-admin-accounts-user-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_user_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_user_add`
...
| Field | Value |
|---|---|
| URL name | `accounts_user_add` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/add/` |
| Pattern | `add/` |
| Named | true |
