---
id: url-card-admin-accounts-user-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_user_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_user_change`
...
| Field | Value |
|---|---|
| URL name | `accounts_user_change` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/<path:object_id>/change/` |
