---
id: url-card-admin-accounts-user-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_user_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_user_changelist`
...
| Field | Value |
|---|---|
| URL name | `accounts_user_changelist` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/` |
