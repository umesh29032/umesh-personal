---
id: url-card-admin-accounts-user-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_user_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `accounts_user_delete`
...
| Field | Value |
|---|---|
| URL name | `accounts_user_delete` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/<path:object_id>/delete/` |
