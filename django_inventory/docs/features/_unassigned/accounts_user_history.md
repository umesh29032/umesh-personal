---
id: url-card-admin-accounts-user-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:accounts_user_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `accounts_user_history`
...
| Field | Value |
|---|---|
| URL name | `accounts_user_history` |
| Namespace | `admin` |
| Mount | `/admin/accounts/user/<path:object_id>/history/` |
