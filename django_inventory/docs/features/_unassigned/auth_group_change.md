---
id: url-card-admin-auth-group-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:auth_group_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `auth_group_change`
...
| Field | Value |
|---|---|
| URL name | `auth_group_change` |
| Namespace | `admin` |
| Mount | `/admin/auth/group/<path:object_id>/change/` |
