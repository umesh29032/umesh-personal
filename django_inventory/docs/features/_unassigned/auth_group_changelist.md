---
id: url-card-admin-auth-group-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:auth_group_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `auth_group_changelist`
...
| Field | Value |
|---|---|
| URL name | `auth_group_changelist` |
| Namespace | `admin` |
| Mount | `/admin/auth/group/` |
