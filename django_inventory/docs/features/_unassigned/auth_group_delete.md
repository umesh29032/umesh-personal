---
id: url-card-admin-auth-group-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:auth_group_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `auth_group_delete`
...
| Field | Value |
|---|---|
| URL name | `auth_group_delete` |
| Namespace | `admin` |
| Mount | `/admin/auth/group/<path:object_id>/delete/` |
