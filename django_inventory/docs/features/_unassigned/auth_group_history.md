---
id: url-card-admin-auth-group-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:auth_group_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `auth_group_history`
...
| Field | Value |
|---|---|
| URL name | `auth_group_history` |
| Namespace | `admin` |
| Mount | `/admin/auth/group/<path:object_id>/history/` |
