---
id: url-card-admin-autocomplete
type: url-card
status: generated
owner: generated
scope: route — url:admin:autocomplete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `autocomplete`
...
| Field | Value |
|---|---|
| URL name | `autocomplete` |
| Namespace | `admin` |
| Mount | `/admin/autocomplete/` |
...
| Field | Value |
|---|---|
| View | `AdminSite.autocomplete_view` |
| Module | `django.contrib.admin.sites` |
| Defined in | `/admin/autocomplete/` |
| Vendor | true |
