---
id: url-card-production-barcode-gen-reopen
type: url-card
status: generated
owner: generated
scope: route — url:production:barcode-gen-reopen
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `barcode-gen-reopen`
...
| Field | Value |
|---|---|
| URL name | `barcode-gen-reopen` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/barcode-gen/reopen/` |
| Pattern | `addas/<str:code>/barcode-gen/reopen/` |
| Named | true |
