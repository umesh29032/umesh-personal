---
id: url-card-tracking-barcode-list
type: url-card
status: generated
owner: generated
scope: route — url:tracking:barcode-list
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `barcode-list`
...
| Field | Value |
|---|---|
| URL name | `barcode-list` |
| Namespace | `tracking` |
| Mount | `/tracking/barcodes/<str:adda_code>/` |
| Pattern | `barcodes/<str:adda_code>/` |
| Named | true |
