---
id: url-card-tracking-barcode-print
type: url-card
status: generated
owner: generated
scope: route — url:tracking:barcode-print
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `barcode-print`
...
| Field | Value |
|---|---|
| URL name | `barcode-print` |
| Namespace | `tracking` |
| Mount | `/tracking/barcodes/<str:adda_code>/print/` |
| Pattern | `barcodes/<str:adda_code>/print/` |
| Named | true |
