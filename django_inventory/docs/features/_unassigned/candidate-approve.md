---
id: url-card-patterns-ai-candidate-approve
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:candidate-approve
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `candidate-approve`
...
| Field | Value |
|---|---|
| URL name | `candidate-approve` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/candidates/<int:pk>/approve/` |
| Pattern | `candidates/<int:pk>/approve/` |
| Named | true |
