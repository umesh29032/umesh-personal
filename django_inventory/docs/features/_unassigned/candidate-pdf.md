---
id: url-card-patterns-ai-candidate-pdf
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:candidate-pdf
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `candidate-pdf`
...
| Field | Value |
|---|---|
| URL name | `candidate-pdf` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/candidates/<int:pk>/pdf/` |
| Pattern | `candidates/<int:pk>/pdf/` |
| Named | true |
