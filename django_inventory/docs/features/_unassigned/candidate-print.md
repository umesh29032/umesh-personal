---
id: url-card-patterns-ai-candidate-print
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:candidate-print
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `candidate-print`
...
| Field | Value |
|---|---|
| URL name | `candidate-print` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/candidates/<int:pk>/print/` |
| Pattern | `candidates/<int:pk>/print/` |
| Named | true |
