---
id: url-card-storefront-category-edit
type: url-card
status: generated
owner: generated
scope: route — url:storefront:category_edit
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `category_edit`
...
| Field | Value |
|---|---|
| URL name | `category_edit` |
| Namespace | `storefront` |
| Mount | `/storefront/categories/<int:pk>/edit/` |
| Pattern | `categories/<int:pk>/edit/` |
| Named | true |
