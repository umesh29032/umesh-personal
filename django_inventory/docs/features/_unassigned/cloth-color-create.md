---
id: url-card-raw-materials-cloth-color-create
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-color-create
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `cloth-color-create`
...
| Field | Value |
|---|---|
| URL name | `cloth-color-create` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-colors/add/` |
| Pattern | `cloth-colors/add/` |
| Named | true |
