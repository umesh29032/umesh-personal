---
id: url-card-raw-materials-cloth-color-delete
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-color-delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `cloth-color-delete`
...
| Field | Value |
|---|---|
| URL name | `cloth-color-delete` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-colors/<int:pk>/delete/` |
| Pattern | `cloth-colors/<int:pk>/delete/` |
| Named | true |
