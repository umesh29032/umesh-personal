---
id: url-card-raw-materials-cloth-type-create
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-type-create
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `cloth-type-create`
...
| Field | Value |
|---|---|
| URL name | `cloth-type-create` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-types/add/` |
| Pattern | `cloth-types/add/` |
| Named | true |
