---
id: url-card-raw-materials-cloth-type-update
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-type-update
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `cloth-type-update`
...
| Field | Value |
|---|---|
| URL name | `cloth-type-update` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-types/<int:pk>/edit/` |
| Pattern | `cloth-types/<int:pk>/edit/` |
| Named | true |
