---
id: url-card-patterns-ai-cutting-table-optimize
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:cutting-table-optimize
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `cutting-table-optimize`
...
| Field | Value |
|---|---|
| URL name | `cutting-table-optimize` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table/<int:pk>/optimize/` |
| Pattern | `table/<int:pk>/optimize/` |
| Named | true |
