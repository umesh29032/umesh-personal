---
id: url-card-admin-expense-addasettlement-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlement_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlement_add`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlement_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/add/` |
| Pattern | `add/` |
| Named | true |
