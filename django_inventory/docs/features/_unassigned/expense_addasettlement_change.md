---
id: url-card-admin-expense-addasettlement-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlement_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_addasettlement_change`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlement_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/<path:object_id>/change/` |
