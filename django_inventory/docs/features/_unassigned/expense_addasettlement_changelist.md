---
id: url-card-admin-expense-addasettlement-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlement_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlement_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlement_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/` |
