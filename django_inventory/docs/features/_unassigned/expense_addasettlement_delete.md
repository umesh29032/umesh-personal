---
id: url-card-admin-expense-addasettlement-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlement_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_addasettlement_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlement_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/<path:object_id>/delete/` |
