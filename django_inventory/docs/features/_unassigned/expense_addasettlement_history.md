---
id: url-card-admin-expense-addasettlement-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlement_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlement_history`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlement_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlement/<path:object_id>/history/` |
