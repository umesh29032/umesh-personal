---
id: url-card-admin-expense-addasettlementitem-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlementitem_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlementitem_add`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlementitem_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlementitem/add/` |
| Pattern | `add/` |
| Named | true |
