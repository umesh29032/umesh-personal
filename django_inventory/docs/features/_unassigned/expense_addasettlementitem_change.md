---
id: url-card-admin-expense-addasettlementitem-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlementitem_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_addasettlementitem_change`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlementitem_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlementitem/<path:object_id>/change/` |
