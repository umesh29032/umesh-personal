---
id: url-card-admin-expense-addasettlementitem-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlementitem_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlementitem_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlementitem_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlementitem/` |
