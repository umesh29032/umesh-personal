---
id: url-card-admin-expense-addasettlementitem-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlementitem_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_addasettlementitem_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlementitem_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlementitem/<path:object_id>/delete/` |
