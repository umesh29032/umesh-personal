---
id: url-card-admin-expense-addasettlementitem-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_addasettlementitem_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_addasettlementitem_history`
...
| Field | Value |
|---|---|
| URL name | `expense_addasettlementitem_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/addasettlementitem/<path:object_id>/history/` |
