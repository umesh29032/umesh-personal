---
id: url-card-admin-expense-expensegenerationrecord-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensegenerationrecord_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensegenerationrecord_add`
...
| Field | Value |
|---|---|
| URL name | `expense_expensegenerationrecord_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensegenerationrecord/add/` |
| Pattern | `add/` |
| Named | true |
