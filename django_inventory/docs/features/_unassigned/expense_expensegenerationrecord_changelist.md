---
id: url-card-admin-expense-expensegenerationrecord-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensegenerationrecord_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensegenerationrecord_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_expensegenerationrecord_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensegenerationrecord/` |
