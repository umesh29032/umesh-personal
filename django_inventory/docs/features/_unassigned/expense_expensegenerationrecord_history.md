---
id: url-card-admin-expense-expensegenerationrecord-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensegenerationrecord_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensegenerationrecord_history`
...
| Field | Value |
|---|---|
| URL name | `expense_expensegenerationrecord_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensegenerationrecord/<path:object_id>/history/` |
