---
id: url-card-admin-expense-expensetemplate-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplate_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensetemplate_add`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplate_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplate/add/` |
| Pattern | `add/` |
| Named | true |
