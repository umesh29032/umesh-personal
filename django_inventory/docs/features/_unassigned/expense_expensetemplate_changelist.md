---
id: url-card-admin-expense-expensetemplate-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplate_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_expensetemplate_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplate_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplate/` |
