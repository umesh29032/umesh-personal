---
id: url-card-admin-expense-expensetemplate-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplate_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensetemplate_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplate_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplate/<path:object_id>/delete/` |
