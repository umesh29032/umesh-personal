---
id: url-card-admin-expense-expensetemplate-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplate_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensetemplate_history`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplate_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplate/<path:object_id>/history/` |
