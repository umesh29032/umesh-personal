---
id: url-card-admin-expense-expensetemplateamountaudit-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplateamountaudit_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_expensetemplateamountaudit_add`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplateamountaudit_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplateamountaudit/add/` |
| Pattern | `add/` |
| Named | true |
