---
id: url-card-admin-expense-expensetemplateamountaudit-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplateamountaudit_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensetemplateamountaudit_change`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplateamountaudit_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplateamountaudit/<path:object_id>/change/` |
