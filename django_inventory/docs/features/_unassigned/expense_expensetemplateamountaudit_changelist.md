---
id: url-card-admin-expense-expensetemplateamountaudit-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplateamountaudit_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_expensetemplateamountaudit_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplateamountaudit_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplateamountaudit/` |
