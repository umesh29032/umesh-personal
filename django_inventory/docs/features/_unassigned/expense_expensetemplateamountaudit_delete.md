---
id: url-card-admin-expense-expensetemplateamountaudit-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplateamountaudit_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_expensetemplateamountaudit_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplateamountaudit_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplateamountaudit/<path:object_id>/delete/` |
