---
id: url-card-admin-expense-expensetemplateamountaudit-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_expensetemplateamountaudit_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_expensetemplateamountaudit_history`
...
| Field | Value |
|---|---|
| URL name | `expense_expensetemplateamountaudit_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/expensetemplateamountaudit/<path:object_id>/history/` |
