---
id: url-card-admin-expense-factoryexpense-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_factoryexpense_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_factoryexpense_add`
...
| Field | Value |
|---|---|
| URL name | `expense_factoryexpense_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/factoryexpense/add/` |
| Pattern | `add/` |
| Named | true |
