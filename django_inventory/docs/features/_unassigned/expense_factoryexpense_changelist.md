---
id: url-card-admin-expense-factoryexpense-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_factoryexpense_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_factoryexpense_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_factoryexpense_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/factoryexpense/` |
