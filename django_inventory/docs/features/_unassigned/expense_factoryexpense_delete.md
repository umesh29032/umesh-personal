---
id: url-card-admin-expense-factoryexpense-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_factoryexpense_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_factoryexpense_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_factoryexpense_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/factoryexpense/<path:object_id>/delete/` |
