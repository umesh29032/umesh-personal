---
id: url-card-admin-expense-factoryexpense-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_factoryexpense_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_factoryexpense_history`
...
| Field | Value |
|---|---|
| URL name | `expense_factoryexpense_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/factoryexpense/<path:object_id>/history/` |
