---
id: url-card-admin-expense-payrollsettlement-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_payrollsettlement_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_payrollsettlement_add`
...
| Field | Value |
|---|---|
| URL name | `expense_payrollsettlement_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/payrollsettlement/add/` |
| Pattern | `add/` |
| Named | true |
