---
id: url-card-admin-expense-payrollsettlement-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_payrollsettlement_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_payrollsettlement_change`
...
| Field | Value |
|---|---|
| URL name | `expense_payrollsettlement_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/payrollsettlement/<path:object_id>/change/` |
