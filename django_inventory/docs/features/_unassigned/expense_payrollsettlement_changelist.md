---
id: url-card-admin-expense-payrollsettlement-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_payrollsettlement_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_payrollsettlement_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_payrollsettlement_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/payrollsettlement/` |
