---
id: url-card-admin-expense-payrollsettlement-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_payrollsettlement_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_payrollsettlement_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_payrollsettlement_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/payrollsettlement/<path:object_id>/delete/` |
