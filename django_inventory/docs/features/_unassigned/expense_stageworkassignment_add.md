---
id: url-card-admin-expense-stageworkassignment-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_stageworkassignment_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_stageworkassignment_add`
...
| Field | Value |
|---|---|
| URL name | `expense_stageworkassignment_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/stageworkassignment/add/` |
| Pattern | `add/` |
| Named | true |
