---
id: url-card-admin-expense-stageworkassignment-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_stageworkassignment_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_stageworkassignment_change`
...
| Field | Value |
|---|---|
| URL name | `expense_stageworkassignment_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/stageworkassignment/<path:object_id>/change/` |
