---
id: url-card-admin-expense-stageworkassignment-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_stageworkassignment_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_stageworkassignment_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_stageworkassignment_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/stageworkassignment/` |
