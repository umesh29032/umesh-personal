---
id: url-card-admin-expense-stageworkassignment-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_stageworkassignment_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_stageworkassignment_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_stageworkassignment_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/stageworkassignment/<path:object_id>/delete/` |
