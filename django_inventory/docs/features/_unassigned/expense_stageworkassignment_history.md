---
id: url-card-admin-expense-stageworkassignment-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_stageworkassignment_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_stageworkassignment_history`
...
| Field | Value |
|---|---|
| URL name | `expense_stageworkassignment_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/stageworkassignment/<path:object_id>/history/` |
