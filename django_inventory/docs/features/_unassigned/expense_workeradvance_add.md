---
id: url-card-admin-expense-workeradvance-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workeradvance_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workeradvance_add`
...
| Field | Value |
|---|---|
| URL name | `expense_workeradvance_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/workeradvance/add/` |
| Pattern | `add/` |
| Named | true |
