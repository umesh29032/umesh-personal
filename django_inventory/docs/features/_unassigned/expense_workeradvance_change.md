---
id: url-card-admin-expense-workeradvance-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workeradvance_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workeradvance_change`
...
| Field | Value |
|---|---|
| URL name | `expense_workeradvance_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/workeradvance/<path:object_id>/change/` |
