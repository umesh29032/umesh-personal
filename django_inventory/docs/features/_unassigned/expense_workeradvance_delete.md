---
id: url-card-admin-expense-workeradvance-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workeradvance_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workeradvance_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_workeradvance_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/workeradvance/<path:object_id>/delete/` |
