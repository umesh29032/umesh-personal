---
id: url-card-admin-expense-workerledgerentry-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerledgerentry_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerledgerentry_add`
...
| Field | Value |
|---|---|
| URL name | `expense_workerledgerentry_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerledgerentry/add/` |
| Pattern | `add/` |
| Named | true |
