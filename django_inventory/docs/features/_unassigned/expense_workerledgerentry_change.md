---
id: url-card-admin-expense-workerledgerentry-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerledgerentry_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerledgerentry_change`
...
| Field | Value |
|---|---|
| URL name | `expense_workerledgerentry_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerledgerentry/<path:object_id>/change/` |
