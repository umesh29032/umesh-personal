---
id: url-card-admin-expense-workerledgerentry-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerledgerentry_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerledgerentry_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_workerledgerentry_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerledgerentry/` |
