---
id: url-card-admin-expense-workerledgerentry-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerledgerentry_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workerledgerentry_history`
...
| Field | Value |
|---|---|
| URL name | `expense_workerledgerentry_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerledgerentry/<path:object_id>/history/` |
