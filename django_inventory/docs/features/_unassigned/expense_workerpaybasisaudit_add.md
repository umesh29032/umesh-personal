---
id: url-card-admin-expense-workerpaybasisaudit-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerpaybasisaudit_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerpaybasisaudit_add`
...
| Field | Value |
|---|---|
| URL name | `expense_workerpaybasisaudit_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerpaybasisaudit/add/` |
| Pattern | `add/` |
| Named | true |
