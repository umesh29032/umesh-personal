---
id: url-card-admin-expense-workerpaybasisaudit-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerpaybasisaudit_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workerpaybasisaudit_change`
...
| Field | Value |
|---|---|
| URL name | `expense_workerpaybasisaudit_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerpaybasisaudit/<path:object_id>/change/` |
