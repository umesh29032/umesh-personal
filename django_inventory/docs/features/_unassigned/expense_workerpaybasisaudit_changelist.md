---
id: url-card-admin-expense-workerpaybasisaudit-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerpaybasisaudit_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerpaybasisaudit_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_workerpaybasisaudit_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerpaybasisaudit/` |
