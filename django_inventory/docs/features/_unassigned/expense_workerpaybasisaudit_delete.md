---
id: url-card-admin-expense-workerpaybasisaudit-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerpaybasisaudit_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerpaybasisaudit_delete`
...
| Field | Value |
|---|---|
| URL name | `expense_workerpaybasisaudit_delete` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerpaybasisaudit/<path:object_id>/delete/` |
