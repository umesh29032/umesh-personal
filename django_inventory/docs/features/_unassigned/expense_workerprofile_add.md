---
id: url-card-admin-expense-workerprofile-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerprofile_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workerprofile_add`
...
| Field | Value |
|---|---|
| URL name | `expense_workerprofile_add` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerprofile/add/` |
| Pattern | `add/` |
| Named | true |
