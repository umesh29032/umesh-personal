---
id: url-card-admin-expense-workerprofile-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerprofile_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `expense_workerprofile_change`
...
| Field | Value |
|---|---|
| URL name | `expense_workerprofile_change` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerprofile/<path:object_id>/change/` |
