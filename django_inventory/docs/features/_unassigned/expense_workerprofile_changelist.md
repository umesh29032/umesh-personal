---
id: url-card-admin-expense-workerprofile-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerprofile_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerprofile_changelist`
...
| Field | Value |
|---|---|
| URL name | `expense_workerprofile_changelist` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerprofile/` |
