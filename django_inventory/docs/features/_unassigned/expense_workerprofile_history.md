---
id: url-card-admin-expense-workerprofile-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:expense_workerprofile_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `expense_workerprofile_history`
...
| Field | Value |
|---|---|
| URL name | `expense_workerprofile_history` |
| Namespace | `admin` |
| Mount | `/admin/expense/workerprofile/<path:object_id>/history/` |
