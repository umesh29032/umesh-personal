---
id: url-card-patterns-ai-extraction-review
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:extraction-review
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `extraction-review`
...
| Field | Value |
|---|---|
| URL name | `extraction-review` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/extractions/<int:pk>/review/` |
| Pattern | `extractions/<int:pk>/review/` |
| Named | true |
