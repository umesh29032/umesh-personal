---
id: url-card-patterns-ai-generation-run
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:generation-run
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `generation-run`
...
| Field | Value |
|---|---|
| URL name | `generation-run` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/runs/<int:pk>/` |
| Pattern | `runs/<int:pk>/` |
| Named | true |
