---
id: url-card-production-generic-stage-complete
type: url-card
status: generated
owner: generated
scope: route — url:production:generic-stage-complete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `generic-stage-complete`
...
| Field | Value |
|---|---|
| URL name | `generic-stage-complete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage/<str:stage_type>/complete/` |
| Pattern | `addas/<str:code>/stage/<str:stage_type>/complete/` |
| Named | true |
