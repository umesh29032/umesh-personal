---
id: url-card-production-generic-stage-reopen
type: url-card
status: generated
owner: generated
scope: route — url:production:generic-stage-reopen
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `generic-stage-reopen`
...
| Field | Value |
|---|---|
| URL name | `generic-stage-reopen` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage/<str:stage_type>/reopen/` |
| Pattern | `addas/<str:code>/stage/<str:stage_type>/reopen/` |
| Named | true |
