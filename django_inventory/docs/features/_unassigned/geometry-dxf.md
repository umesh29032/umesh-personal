---
id: url-card-patterns-ai-geometry-dxf
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:geometry-dxf
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `geometry-dxf`
...
| Field | Value |
|---|---|
| URL name | `geometry-dxf` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/geometry/<int:pk>/dxf/` |
| Pattern | `geometry/<int:pk>/dxf/` |
| Named | true |
