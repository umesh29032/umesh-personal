---
id: url-card-patterns-ai-geometry-edit
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:geometry-edit
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `geometry-edit`
...
| Field | Value |
|---|---|
| URL name | `geometry-edit` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/geometry/<int:pk>/edit/` |
| Pattern | `geometry/<int:pk>/edit/` |
| Named | true |
