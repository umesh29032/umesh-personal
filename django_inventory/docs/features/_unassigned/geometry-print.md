---
id: url-card-patterns-ai-geometry-print
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:geometry-print
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `geometry-print`
...
| Field | Value |
|---|---|
| URL name | `geometry-print` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/geometry/<int:pk>/print/` |
| Pattern | `geometry/<int:pk>/print/` |
| Named | true |
