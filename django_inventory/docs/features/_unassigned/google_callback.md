---
id: url-card-google-callback
type: url-card
status: generated
owner: generated
scope: route — url:google_callback
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `google_callback`
...
| Field | Value |
|---|---|
| URL name | `google_callback` |
| Namespace | — (none) |
| Mount | `/accounts/google/login/callback/` |
...
| Field | Value |
|---|---|
| View | `OAuth2View.adapter_view.<locals>.view` |
| Module | `allauth.socialaccount.providers.oauth2.views` |
| Defined in | `/accounts/google/login/` |
| Vendor | true |
