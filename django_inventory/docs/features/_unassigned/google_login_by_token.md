---
id: url-card-google-login-by-token
type: url-card
status: generated
owner: generated
scope: route — url:google_login_by_token
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `google_login_by_token`
...
| Field | Value |
|---|---|
| URL name | `google_login_by_token` |
| Namespace | — (none) |
| Mount | `/accounts/google/login/token/` |
| Pattern | `google/login/token/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `LoginByTokenView` |
| Module | `allauth.socialaccount.providers.google.views` |
| Defined in | `/accounts/google/login/token/` |
| Vendor | true |
