---
id: url-card-production-machine-type-edit
type: url-card
status: generated
owner: generated
scope: route — url:production:machine-type-edit
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `machine-type-edit`
...
| Field | Value |
|---|---|
| URL name | `machine-type-edit` |
| Namespace | `production` |
| Mount | `/production/machine-types/<int:pk>/edit/` |
| Pattern | `machine-types/<int:pk>/edit/` |
| Named | true |
