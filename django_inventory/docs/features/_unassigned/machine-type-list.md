---
id: url-card-production-machine-type-list
type: url-card
status: generated
owner: generated
scope: route — url:production:machine-type-list
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `machine-type-list`
...
| Field | Value |
|---|---|
| URL name | `machine-type-list` |
| Namespace | `production` |
| Mount | `/production/machine-types/` |
| Pattern | `machine-types/` |
| Named | true |
