---
id: url-card-patterns-ai-manual-marker-created
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:manual-marker-created
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `manual-marker-created`
...
| Field | Value |
|---|---|
| URL name | `manual-marker-created` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/markers/<str:reference>/created/` |
| Pattern | `markers/<str:reference>/created/` |
| Named | true |
