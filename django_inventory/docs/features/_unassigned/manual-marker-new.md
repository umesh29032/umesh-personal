---
id: url-card-patterns-ai-manual-marker-new
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:manual-marker-new
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `manual-marker-new`
...
| Field | Value |
|---|---|
| URL name | `manual-marker-new` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/markers/manual/new/` |
| Pattern | `markers/manual/new/` |
| Named | true |
