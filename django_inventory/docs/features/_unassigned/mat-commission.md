---
id: url-card-patterns-ai-mat-commission
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:mat-commission
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `mat-commission`
...
| Field | Value |
|---|---|
| URL name | `mat-commission` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/mats/<int:pk>/commission/` |
| Pattern | `mats/<int:pk>/commission/` |
| Named | true |
