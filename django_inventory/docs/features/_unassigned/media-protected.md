---
id: url-card-media-protected
type: url-card
status: generated
owner: generated
scope: route — url:media-protected
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `media-protected`
...
| Field | Value |
|---|---|
| URL name | `media-protected` |
| Namespace | — (none) |
| Mount | `/media/<path:path>` |
| Pattern | `media/<path:path>` |
| Named | true |
