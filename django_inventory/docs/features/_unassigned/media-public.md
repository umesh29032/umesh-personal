---
id: url-card-media-public
type: url-card
status: generated
owner: generated
scope: route — url:media-public
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `media-public`
...
| Field | Value |
|---|---|
| URL name | `media-public` |
| Namespace | — (none) |
| Mount | `/media/storefront/<path:path>` |
| Pattern | `media/storefront/<path:path>` |
| Named | true |
