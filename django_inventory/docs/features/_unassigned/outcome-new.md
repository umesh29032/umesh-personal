---
id: url-card-patterns-ai-outcome-new
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:outcome-new
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `outcome-new`
...
| Field | Value |
|---|---|
| URL name | `outcome-new` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/usages/<int:pk>/outcome/new/` |
| Pattern | `usages/<int:pk>/outcome/new/` |
| Named | true |
