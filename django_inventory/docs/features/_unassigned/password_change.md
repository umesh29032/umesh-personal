---
id: url-card-admin-password-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:password_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `password_change`
...
| Field | Value |
|---|---|
| View | `AdminSite.password_change` |
| Module | `django.contrib.admin.sites` |
| Defined in | `/admin/password_change/` |
| Vendor | true |
