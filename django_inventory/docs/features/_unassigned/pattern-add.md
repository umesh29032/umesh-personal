---
id: url-card-production-pattern-add
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `pattern-add`
...
| Field | Value |
|---|---|
| URL name | `pattern-add` |
| Namespace | `production` |
| Mount | `/production/patterns/add/` |
