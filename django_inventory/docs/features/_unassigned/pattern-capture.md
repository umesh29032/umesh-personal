---
id: url-card-patterns-ai-pattern-capture
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:pattern-capture
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `pattern-capture`
...
| Field | Value |
|---|---|
| URL name | `pattern-capture` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/pieces/<int:pk>/capture/` |
| Pattern | `pieces/<int:pk>/capture/` |
| Named | true |
