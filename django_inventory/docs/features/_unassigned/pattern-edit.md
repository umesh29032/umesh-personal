---
id: url-card-production-pattern-edit
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-edit
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `pattern-edit`
...
| Field | Value |
|---|---|
| URL name | `pattern-edit` |
| Namespace | `production` |
| Mount | `/production/patterns/<int:pk>/edit/` |
| Pattern | `patterns/<int:pk>/edit/` |
| Named | true |
