---
id: url-card-production-pattern-list
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-list
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `pattern-list`
...
| Field | Value |
|---|---|
| URL name | `pattern-list` |
| Namespace | `production` |
| Mount | `/production/patterns/` |
| Pattern | `patterns/` |
| Named | true |
