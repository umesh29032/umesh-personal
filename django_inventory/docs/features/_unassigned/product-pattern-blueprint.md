---
id: url-card-production-product-pattern-blueprint
type: url-card
status: generated
owner: generated
scope: route — url:production:product-pattern-blueprint
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `product-pattern-blueprint`
...
| Field | Value |
|---|---|
| URL name | `product-pattern-blueprint` |
| Namespace | `production` |
| Mount | `/production/products/<int:pk>/patterns/blueprint/` |
| Pattern | `products/<int:pk>/patterns/blueprint/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `ProductPatternBlueprintRedirectView` |
