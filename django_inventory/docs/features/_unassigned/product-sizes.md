---
id: url-card-production-product-sizes
type: url-card
status: generated
owner: generated
scope: route — url:production:product-sizes
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `product-sizes`
...
| Field | Value |
|---|---|
| URL name | `product-sizes` |
| Namespace | `production` |
| Mount | `/production/products/<int:pk>/sizes/` |
| Pattern | `products/<int:pk>/sizes/` |
| Named | true |
