---
id: url-card-storefront-product-edit
type: url-card
status: generated
owner: generated
scope: route — url:storefront:product_edit
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `product_edit`
...
| Field | Value |
|---|---|
| URL name | `product_edit` |
| Namespace | `storefront` |
| Mount | `/storefront/products/<int:pk>/edit/` |
| Pattern | `products/<int:pk>/edit/` |
| Named | true |
