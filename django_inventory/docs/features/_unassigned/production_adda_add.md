---
id: url-card-admin-production-adda-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_adda_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_adda_add`
...
| Field | Value |
|---|---|
| URL name | `production_adda_add` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/add/` |
| Pattern | `add/` |
| Named | true |
