---
id: url-card-admin-production-adda-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_adda_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_adda_change`
...
| Field | Value |
|---|---|
| URL name | `production_adda_change` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/<path:object_id>/change/` |
