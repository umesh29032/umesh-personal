---
id: url-card-admin-production-adda-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_adda_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_adda_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_adda_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/` |
