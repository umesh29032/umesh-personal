---
id: url-card-admin-production-adda-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_adda_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_adda_delete`
...
| Field | Value |
|---|---|
| URL name | `production_adda_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/<path:object_id>/delete/` |
