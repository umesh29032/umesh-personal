---
id: url-card-admin-production-adda-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_adda_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_adda_history`
...
| Field | Value |
|---|---|
| URL name | `production_adda_history` |
| Namespace | `admin` |
| Mount | `/admin/production/adda/<path:object_id>/history/` |
