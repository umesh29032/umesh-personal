---
id: url-card-admin-production-cuttingbundle-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundle_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingbundle_add`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundle_add` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundle/add/` |
| Pattern | `add/` |
| Named | true |
