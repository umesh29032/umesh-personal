---
id: url-card-admin-production-cuttingbundle-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundle_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingbundle_change`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundle_change` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundle/<path:object_id>/change/` |
