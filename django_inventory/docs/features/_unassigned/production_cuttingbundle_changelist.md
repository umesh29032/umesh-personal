---
id: url-card-admin-production-cuttingbundle-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundle_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingbundle_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundle_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundle/` |
