---
id: url-card-admin-production-cuttingbundle-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundle_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingbundle_delete`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundle_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundle/<path:object_id>/delete/` |
