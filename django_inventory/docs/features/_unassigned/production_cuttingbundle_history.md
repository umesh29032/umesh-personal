---
id: url-card-admin-production-cuttingbundle-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundle_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingbundle_history`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundle_history` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundle/<path:object_id>/history/` |
