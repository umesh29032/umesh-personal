---
id: url-card-admin-production-cuttingbundleitem-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundleitem_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingbundleitem_add`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundleitem_add` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundleitem/add/` |
| Pattern | `add/` |
| Named | true |
