---
id: url-card-admin-production-cuttingbundleitem-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundleitem_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingbundleitem_change`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundleitem_change` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundleitem/<path:object_id>/change/` |
