---
id: url-card-admin-production-cuttingbundleitem-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundleitem_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingbundleitem_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundleitem_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundleitem/` |
