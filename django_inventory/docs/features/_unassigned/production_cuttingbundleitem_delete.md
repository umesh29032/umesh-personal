---
id: url-card-admin-production-cuttingbundleitem-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundleitem_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingbundleitem_delete`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundleitem_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundleitem/<path:object_id>/delete/` |
