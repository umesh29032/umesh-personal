---
id: url-card-admin-production-cuttingbundleitem-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingbundleitem_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingbundleitem_history`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingbundleitem_history` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingbundleitem/<path:object_id>/history/` |
