---
id: url-card-admin-production-cuttingpatternsizeallocation-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternsizeallocation_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternsizeallocation_add`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternsizeallocation_add` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/add/` |
| Pattern | `add/` |
| Named | true |
...
| Defined in | `/admin/account/emailaddress/add/` |
| Vendor | true |
