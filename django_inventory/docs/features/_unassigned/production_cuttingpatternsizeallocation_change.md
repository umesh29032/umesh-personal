---
id: url-card-admin-production-cuttingpatternsizeallocation-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternsizeallocation_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternsizeallocation_change`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternsizeallocation_change` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/<path:object_id>/change/` |
...
| Defined in | `/admin/account/emailaddress/<path:object_id>/change/` |
| Vendor | true |
