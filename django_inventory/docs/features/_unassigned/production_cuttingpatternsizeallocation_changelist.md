---
id: url-card-admin-production-cuttingpatternsizeallocation-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternsizeallocation_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternsizeallocation_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternsizeallocation_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/` |
