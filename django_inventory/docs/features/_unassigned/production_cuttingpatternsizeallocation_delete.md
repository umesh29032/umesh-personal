---
id: url-card-admin-production-cuttingpatternsizeallocation-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternsizeallocation_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternsizeallocation_delete`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternsizeallocation_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/<path:object_id>/delete/` |
...
| Field | Value |
|---|---|
| View | `ModelAdmin.delete_view` |
| Module | `django.contrib.admin.options` |
| Defined in | `/admin/account/emailaddress/<path:object_id>/delete/` |
| Vendor | true |
