---
id: url-card-admin-production-cuttingpatternsizeallocation-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternsizeallocation_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternsizeallocation_history`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternsizeallocation_history` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternsizeallocation/<path:object_id>/history/` |
...
| Field | Value |
|---|---|
| View | `ModelAdmin.history_view` |
| Module | `django.contrib.admin.options` |
| Defined in | `/admin/account/emailaddress/<path:object_id>/history/` |
| Vendor | true |
