---
id: url-card-admin-production-cuttingpatternverification-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternverification_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternverification_add`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternverification_add` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternverification/add/` |
| Pattern | `add/` |
| Named | true |
