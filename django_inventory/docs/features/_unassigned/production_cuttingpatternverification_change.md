---
id: url-card-admin-production-cuttingpatternverification-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternverification_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternverification_change`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternverification_change` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternverification/<path:object_id>/change/` |
