---
id: url-card-admin-production-cuttingpatternverification-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpatternverification_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpatternverification_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpatternverification_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpatternverification/` |
