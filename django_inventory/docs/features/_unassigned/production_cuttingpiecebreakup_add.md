---
id: url-card-admin-production-cuttingpiecebreakup-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpiecebreakup_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingpiecebreakup_add`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpiecebreakup_add` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpiecebreakup/add/` |
| Pattern | `add/` |
| Named | true |
