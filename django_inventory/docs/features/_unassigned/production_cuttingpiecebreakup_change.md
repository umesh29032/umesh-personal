---
id: url-card-admin-production-cuttingpiecebreakup-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpiecebreakup_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpiecebreakup_change`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpiecebreakup_change` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpiecebreakup/<path:object_id>/change/` |
