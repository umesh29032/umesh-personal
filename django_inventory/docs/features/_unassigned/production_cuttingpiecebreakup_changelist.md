---
id: url-card-admin-production-cuttingpiecebreakup-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpiecebreakup_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_cuttingpiecebreakup_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpiecebreakup_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpiecebreakup/` |
