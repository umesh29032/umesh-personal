---
id: url-card-admin-production-cuttingpiecebreakup-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpiecebreakup_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingpiecebreakup_delete`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpiecebreakup_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpiecebreakup/<path:object_id>/delete/` |
