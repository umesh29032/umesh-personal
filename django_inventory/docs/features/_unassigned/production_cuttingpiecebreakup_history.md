---
id: url-card-admin-production-cuttingpiecebreakup-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_cuttingpiecebreakup_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_cuttingpiecebreakup_history`
...
| Field | Value |
|---|---|
| URL name | `production_cuttingpiecebreakup_history` |
| Namespace | `admin` |
| Mount | `/admin/production/cuttingpiecebreakup/<path:object_id>/history/` |
