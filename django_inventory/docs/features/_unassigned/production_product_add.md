---
id: url-card-admin-production-product-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_product_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_product_add`
...
| Field | Value |
|---|---|
| URL name | `production_product_add` |
| Namespace | `admin` |
| Mount | `/admin/production/product/add/` |
| Pattern | `add/` |
| Named | true |
