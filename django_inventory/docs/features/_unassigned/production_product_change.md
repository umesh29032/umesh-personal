---
id: url-card-admin-production-product-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_product_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_product_change`
...
| Field | Value |
|---|---|
| URL name | `production_product_change` |
| Namespace | `admin` |
| Mount | `/admin/production/product/<path:object_id>/change/` |
