---
id: url-card-admin-production-product-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_product_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_product_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_product_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/product/` |
