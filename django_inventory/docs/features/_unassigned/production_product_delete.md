---
id: url-card-admin-production-product-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_product_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_product_delete`
...
| Field | Value |
|---|---|
| URL name | `production_product_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/product/<path:object_id>/delete/` |
