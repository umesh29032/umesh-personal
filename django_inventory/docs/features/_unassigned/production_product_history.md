---
id: url-card-admin-production-product-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_product_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_product_history`
...
| Field | Value |
|---|---|
| URL name | `production_product_history` |
| Namespace | `admin` |
| Mount | `/admin/production/product/<path:object_id>/history/` |
