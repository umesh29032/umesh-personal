---
id: url-card-admin-production-productsize-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_productsize_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_productsize_add`
...
| Field | Value |
|---|---|
| URL name | `production_productsize_add` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/add/` |
| Pattern | `add/` |
| Named | true |
