---
id: url-card-admin-production-productsize-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_productsize_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_productsize_change`
...
| Field | Value |
|---|---|
| URL name | `production_productsize_change` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/<path:object_id>/change/` |
