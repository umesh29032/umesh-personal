---
id: url-card-admin-production-productsize-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_productsize_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_productsize_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_productsize_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/` |
