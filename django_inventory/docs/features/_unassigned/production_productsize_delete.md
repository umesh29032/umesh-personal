---
id: url-card-admin-production-productsize-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_productsize_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_productsize_delete`
...
| Field | Value |
|---|---|
| URL name | `production_productsize_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/<path:object_id>/delete/` |
