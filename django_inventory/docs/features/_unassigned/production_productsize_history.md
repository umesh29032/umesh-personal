---
id: url-card-admin-production-productsize-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_productsize_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_productsize_history`
...
| Field | Value |
|---|---|
| URL name | `production_productsize_history` |
| Namespace | `admin` |
| Mount | `/admin/production/productsize/<path:object_id>/history/` |
