---
id: url-card-admin-production-stage-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_stage_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_stage_add`
...
| Field | Value |
|---|---|
| URL name | `production_stage_add` |
| Namespace | `admin` |
| Mount | `/admin/production/stage/add/` |
| Pattern | `add/` |
| Named | true |
