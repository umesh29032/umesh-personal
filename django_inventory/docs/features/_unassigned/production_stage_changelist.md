---
id: url-card-admin-production-stage-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_stage_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_stage_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_stage_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/stage/` |
