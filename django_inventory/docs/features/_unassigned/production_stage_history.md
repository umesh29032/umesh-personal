---
id: url-card-admin-production-stage-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_stage_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_stage_history`
...
| Field | Value |
|---|---|
| URL name | `production_stage_history` |
| Namespace | `admin` |
| Mount | `/admin/production/stage/<path:object_id>/history/` |
