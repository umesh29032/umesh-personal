---
id: url-card-admin-production-workflowstage-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_workflowstage_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_workflowstage_add`
...
| Field | Value |
|---|---|
| URL name | `production_workflowstage_add` |
| Namespace | `admin` |
| Mount | `/admin/production/workflowstage/add/` |
| Pattern | `add/` |
| Named | true |
