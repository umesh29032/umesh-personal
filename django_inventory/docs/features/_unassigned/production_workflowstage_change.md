---
id: url-card-admin-production-workflowstage-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_workflowstage_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_workflowstage_change`
...
| Field | Value |
|---|---|
| URL name | `production_workflowstage_change` |
| Namespace | `admin` |
| Mount | `/admin/production/workflowstage/<path:object_id>/change/` |
