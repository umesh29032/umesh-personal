---
id: url-card-admin-production-workflowstage-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_workflowstage_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_workflowstage_changelist`
...
| Field | Value |
|---|---|
| URL name | `production_workflowstage_changelist` |
| Namespace | `admin` |
| Mount | `/admin/production/workflowstage/` |
