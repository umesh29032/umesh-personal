---
id: url-card-admin-production-workflowstage-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_workflowstage_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `production_workflowstage_delete`
...
| Field | Value |
|---|---|
| URL name | `production_workflowstage_delete` |
| Namespace | `admin` |
| Mount | `/admin/production/workflowstage/<path:object_id>/delete/` |
