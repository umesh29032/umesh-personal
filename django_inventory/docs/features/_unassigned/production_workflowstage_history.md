---
id: url-card-admin-production-workflowstage-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:production_workflowstage_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `production_workflowstage_history`
...
| Field | Value |
|---|---|
| URL name | `production_workflowstage_history` |
| Namespace | `admin` |
| Mount | `/admin/production/workflowstage/<path:object_id>/history/` |
