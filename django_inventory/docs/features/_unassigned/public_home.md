---
id: url-card-public-home
type: url-card
status: generated
owner: generated
scope: route — url:public_home
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `public_home`
...
|---|---|
| View | `public_home` |
| Module | `storefront.views.public_views` |
| Defined in | `config/storefront/views/public_views.py` |
| Vendor | false |

## App

Derived from the view module (`storefront.views.public_views` → app `storefront`; a render rule, not a graph edge).
