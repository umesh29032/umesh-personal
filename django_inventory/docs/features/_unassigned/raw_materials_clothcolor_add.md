---
id: url-card-admin-raw-materials-clothcolor-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothcolor_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothcolor_add`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothcolor_add` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/add/` |
| Pattern | `add/` |
| Named | true |
