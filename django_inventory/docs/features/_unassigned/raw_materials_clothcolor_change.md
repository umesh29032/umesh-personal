---
id: url-card-admin-raw-materials-clothcolor-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothcolor_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `raw_materials_clothcolor_change`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothcolor_change` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/<path:object_id>/change/` |
