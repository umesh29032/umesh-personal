---
id: url-card-admin-raw-materials-clothcolor-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothcolor_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothcolor_changelist`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothcolor_changelist` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/` |
