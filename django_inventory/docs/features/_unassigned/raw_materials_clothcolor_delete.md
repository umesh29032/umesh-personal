---
id: url-card-admin-raw-materials-clothcolor-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothcolor_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `raw_materials_clothcolor_delete`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothcolor_delete` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/<path:object_id>/delete/` |
