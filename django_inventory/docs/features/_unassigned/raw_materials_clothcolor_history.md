---
id: url-card-admin-raw-materials-clothcolor-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothcolor_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothcolor_history`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothcolor_history` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothcolor/<path:object_id>/history/` |
