---
id: url-card-admin-raw-materials-clothroll-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothroll_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothroll_add`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothroll_add` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothroll/add/` |
| Pattern | `add/` |
| Named | true |
