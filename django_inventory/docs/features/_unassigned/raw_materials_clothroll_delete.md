---
id: url-card-admin-raw-materials-clothroll-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothroll_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothroll_delete`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothroll_delete` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothroll/<path:object_id>/delete/` |
