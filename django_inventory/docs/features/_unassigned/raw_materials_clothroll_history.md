---
id: url-card-admin-raw-materials-clothroll-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothroll_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `raw_materials_clothroll_history`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothroll_history` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothroll/<path:object_id>/history/` |
