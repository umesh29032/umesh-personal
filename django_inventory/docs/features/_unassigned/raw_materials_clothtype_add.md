---
id: url-card-admin-raw-materials-clothtype-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothtype_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `raw_materials_clothtype_add`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothtype_add` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothtype/add/` |
| Pattern | `add/` |
| Named | true |
