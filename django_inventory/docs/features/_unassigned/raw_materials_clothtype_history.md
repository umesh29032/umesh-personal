---
id: url-card-admin-raw-materials-clothtype-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_clothtype_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_clothtype_history`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_clothtype_history` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/clothtype/<path:object_id>/history/` |
