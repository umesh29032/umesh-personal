---
id: url-card-admin-raw-materials-storagelocation-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:raw_materials_storagelocation_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `raw_materials_storagelocation_change`
...
| Field | Value |
|---|---|
| URL name | `raw_materials_storagelocation_change` |
| Namespace | `admin` |
| Mount | `/admin/raw_materials/storagelocation/<path:object_id>/change/` |
