---
id: url-card-machines-release
type: url-card
status: generated
owner: generated
scope: route — url:machines:release
...
| URL name | `release` |
| Namespace | `machines` |
| Mount | `/machines/assignments/<int:pk>/release/` |
| Pattern | `assignments/<int:pk>/release/` |
| Named | true |
