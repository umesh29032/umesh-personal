---
id: url-card-inventory-sidebar-access
type: url-card
status: generated
owner: generated
scope: route — url:inventory:sidebar-access
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `sidebar-access`
...
| Field | Value |
|---|---|
| URL name | `sidebar-access` |
| Namespace | `inventory` |
| Mount | `/inventory/sidebar-access/` |
| Pattern | `sidebar-access/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `SidebarAccessListView` |
| Module | `inventory.views.sidebar_access_views` |
| Defined in | `config/inventory/views/sidebar_access_views.py` |
| Vendor | false |

## App

Derived from the view module (`inventory.views.sidebar_access_views` → app `inventory`; a render rule, not a graph edge).
