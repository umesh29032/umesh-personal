---
id: url-card-admin-sites-site-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:sites_site_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `sites_site_change`
...
| Field | Value |
|---|---|
| URL name | `sites_site_change` |
| Namespace | `admin` |
| Mount | `/admin/sites/site/<path:object_id>/change/` |
