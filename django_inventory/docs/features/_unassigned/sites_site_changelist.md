---
id: url-card-admin-sites-site-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:sites_site_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `sites_site_changelist`
...
| Field | Value |
|---|---|
| URL name | `sites_site_changelist` |
| Namespace | `admin` |
| Mount | `/admin/sites/site/` |
