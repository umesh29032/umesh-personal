---
id: url-card-admin-sites-site-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:sites_site_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `sites_site_delete`
...
| Field | Value |
|---|---|
| URL name | `sites_site_delete` |
| Namespace | `admin` |
| Mount | `/admin/sites/site/<path:object_id>/delete/` |
