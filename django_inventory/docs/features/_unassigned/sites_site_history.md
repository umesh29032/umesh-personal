---
id: url-card-admin-sites-site-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:sites_site_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `sites_site_history`
...
| Field | Value |
|---|---|
| URL name | `sites_site_history` |
| Namespace | `admin` |
| Mount | `/admin/sites/site/<path:object_id>/history/` |
