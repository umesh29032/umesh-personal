---
id: url-card-accounts-skill-delete
type: url-card
status: generated
owner: generated
scope: route — url:accounts:skill_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `skill_delete`
...
| Field | Value |
|---|---|
| URL name | `skill_delete` |
| Namespace | `accounts` |
| Mount | `/app/skills/<int:pk>/delete/` |
| Pattern | `skills/<int:pk>/delete/` |
| Named | true |
