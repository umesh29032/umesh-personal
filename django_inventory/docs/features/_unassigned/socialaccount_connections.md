---
id: url-card-socialaccount-connections
type: url-card
status: generated
owner: generated
scope: route — url:socialaccount_connections
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_connections`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_connections` |
| Namespace | — (none) |
| Mount | `/accounts/social/connections/` |
| Pattern | `connections/` |
| Named | true |
...
| Defined in | `/accounts/social/connections/` |
| Vendor | true |
