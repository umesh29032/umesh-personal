---
id: url-card-socialaccount-login-cancelled
type: url-card
status: generated
owner: generated
scope: route — url:socialaccount_login_cancelled
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_login_cancelled`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_login_cancelled` |
| Namespace | — (none) |
| Mount | `/accounts/social/login/cancelled/` |
...
| Field | Value |
|---|---|
| View | `LoginCancelledView` |
| Module | `allauth.socialaccount.views` |
| Defined in | `/accounts/social/login/cancelled/` |
| Vendor | true |
