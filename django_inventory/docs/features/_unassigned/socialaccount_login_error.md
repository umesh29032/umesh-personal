---
id: url-card-socialaccount-login-error
type: url-card
status: generated
owner: generated
scope: route — url:socialaccount_login_error
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_login_error`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_login_error` |
| Namespace | — (none) |
| Mount | `/accounts/social/login/error/` |
| Pattern | `login/error/` |
| Named | true |
...
| Defined in | `/accounts/social/login/error/` |
| Vendor | true |
