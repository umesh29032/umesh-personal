---
id: url-card-socialaccount-signup
type: url-card
status: generated
owner: generated
scope: route — url:socialaccount_signup
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_signup`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_signup` |
| Namespace | — (none) |
| Mount | `/accounts/social/signup/` |
| Pattern | `signup/` |
| Named | true |
...
| Defined in | `/accounts/social/signup/` |
| Vendor | true |
