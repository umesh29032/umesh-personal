---
id: url-card-admin-socialaccount-socialaccount-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialaccount_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialaccount_add`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialaccount_add` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialaccount/add/` |
| Pattern | `add/` |
| Named | true |
