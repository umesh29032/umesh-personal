---
id: url-card-admin-socialaccount-socialaccount-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialaccount_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialaccount_change`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialaccount_change` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialaccount/<path:object_id>/change/` |
