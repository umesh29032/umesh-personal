---
id: url-card-admin-socialaccount-socialaccount-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialaccount_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialaccount_changelist`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialaccount_changelist` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialaccount/` |
