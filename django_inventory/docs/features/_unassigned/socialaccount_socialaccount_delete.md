---
id: url-card-admin-socialaccount-socialaccount-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialaccount_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialaccount_delete`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialaccount_delete` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialaccount/<path:object_id>/delete/` |
