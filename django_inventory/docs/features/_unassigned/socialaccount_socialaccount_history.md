---
id: url-card-admin-socialaccount-socialaccount-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialaccount_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialaccount_history`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialaccount_history` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialaccount/<path:object_id>/history/` |
