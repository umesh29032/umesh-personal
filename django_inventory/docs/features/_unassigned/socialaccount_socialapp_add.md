---
id: url-card-admin-socialaccount-socialapp-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialapp_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialapp_add`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialapp_add` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialapp/add/` |
| Pattern | `add/` |
| Named | true |
