---
id: url-card-admin-socialaccount-socialapp-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialapp_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialapp_change`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialapp_change` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialapp/<path:object_id>/change/` |
