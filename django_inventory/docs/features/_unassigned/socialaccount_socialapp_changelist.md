---
id: url-card-admin-socialaccount-socialapp-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialapp_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialapp_changelist`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialapp_changelist` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialapp/` |
