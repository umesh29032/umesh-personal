---
id: url-card-admin-socialaccount-socialapp-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialapp_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialapp_delete`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialapp_delete` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialapp/<path:object_id>/delete/` |
