---
id: url-card-admin-socialaccount-socialapp-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialapp_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialapp_history`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialapp_history` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialapp/<path:object_id>/history/` |
