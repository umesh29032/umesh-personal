---
id: url-card-admin-socialaccount-socialtoken-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialtoken_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialtoken_add`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialtoken_add` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/add/` |
| Pattern | `add/` |
| Named | true |
