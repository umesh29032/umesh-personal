---
id: url-card-admin-socialaccount-socialtoken-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialtoken_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialtoken_change`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialtoken_change` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/<path:object_id>/change/` |
