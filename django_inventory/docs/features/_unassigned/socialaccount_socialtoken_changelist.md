---
id: url-card-admin-socialaccount-socialtoken-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialtoken_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `socialaccount_socialtoken_changelist`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialtoken_changelist` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/` |
