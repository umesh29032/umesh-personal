---
id: url-card-admin-socialaccount-socialtoken-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialtoken_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialtoken_delete`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialtoken_delete` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/<path:object_id>/delete/` |
