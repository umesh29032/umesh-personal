---
id: url-card-admin-socialaccount-socialtoken-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:socialaccount_socialtoken_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `socialaccount_socialtoken_history`
...
| Field | Value |
|---|---|
| URL name | `socialaccount_socialtoken_history` |
| Namespace | `admin` |
| Mount | `/admin/socialaccount/socialtoken/<path:object_id>/history/` |
