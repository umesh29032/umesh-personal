---
id: url-card-production-stage-advanced
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-advanced
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `stage-advanced`
...
| Field | Value |
|---|---|
| URL name | `stage-advanced` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage-advanced/` |
| Pattern | `addas/<str:code>/stage-advanced/` |
| Named | true |
