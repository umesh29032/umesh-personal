---
id: url-card-production-stage-category-add
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-category-add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `stage-category-add`
...
| Field | Value |
|---|---|
| URL name | `stage-category-add` |
| Namespace | `production` |
| Mount | `/production/stage-categories/add/` |
| Pattern | `stage-categories/add/` |
| Named | true |
