---
id: url-card-production-stage-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `stage-delete`
...
| Field | Value |
|---|---|
| URL name | `stage-delete` |
| Namespace | `production` |
| Mount | `/production/stages/<int:pk>/delete/` |
| Pattern | `stages/<int:pk>/delete/` |
| Named | true |
