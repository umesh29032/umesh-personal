---
id: url-card-production-stage-edit
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-edit
...
| Mount | `/production/stages/<int:pk>/edit/` |
| Pattern | `stages/<int:pk>/edit/` |
| Named | true |
