---
id: url-card-production-stage-panel
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-panel
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `stage-panel`
...
| Field | Value |
|---|---|
| URL name | `stage-panel` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage/<str:stage_type>/` |
| Pattern | `addas/<str:code>/stage/<str:stage_type>/` |
| Named | true |
