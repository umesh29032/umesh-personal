---
id: url-card-raw-materials-storage-create
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:storage-create
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storage-create`
...
| Field | Value |
|---|---|
| URL name | `storage-create` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/storage-locations/add/` |
| Pattern | `storage-locations/add/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `StorageLocationCreateView` |
