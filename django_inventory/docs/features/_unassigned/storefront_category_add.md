---
id: url-card-admin-storefront-category-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_category_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_category_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_category_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/category/add/` |
| Pattern | `add/` |
| Named | true |
