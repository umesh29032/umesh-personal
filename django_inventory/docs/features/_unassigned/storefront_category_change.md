---
id: url-card-admin-storefront-category-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_category_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_category_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_category_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/category/<path:object_id>/change/` |
