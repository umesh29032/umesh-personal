---
id: url-card-admin-storefront-category-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_category_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_category_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_category_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/category/` |
