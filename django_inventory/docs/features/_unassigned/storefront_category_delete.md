---
id: url-card-admin-storefront-category-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_category_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_category_delete`
...
| Field | Value |
|---|---|
| URL name | `storefront_category_delete` |
| Namespace | `admin` |
| Mount | `/admin/storefront/category/<path:object_id>/delete/` |
