---
id: url-card-admin-storefront-category-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_category_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_category_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_category_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/category/<path:object_id>/history/` |
