---
id: url-card-admin-storefront-featuredproduct-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_featuredproduct_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_featuredproduct_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_featuredproduct_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/featuredproduct/add/` |
| Pattern | `add/` |
| Named | true |
