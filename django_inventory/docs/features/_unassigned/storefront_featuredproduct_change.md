---
id: url-card-admin-storefront-featuredproduct-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_featuredproduct_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_featuredproduct_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_featuredproduct_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/featuredproduct/<path:object_id>/change/` |
