---
id: url-card-admin-storefront-featuredproduct-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_featuredproduct_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_featuredproduct_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_featuredproduct_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/featuredproduct/` |
