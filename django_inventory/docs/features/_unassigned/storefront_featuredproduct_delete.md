---
id: url-card-admin-storefront-featuredproduct-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_featuredproduct_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_featuredproduct_delete`
...
| Field | Value |
|---|---|
| URL name | `storefront_featuredproduct_delete` |
| Namespace | `admin` |
| Mount | `/admin/storefront/featuredproduct/<path:object_id>/delete/` |
