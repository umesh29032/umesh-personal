---
id: url-card-admin-storefront-featuredproduct-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_featuredproduct_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_featuredproduct_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_featuredproduct_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/featuredproduct/<path:object_id>/history/` |
