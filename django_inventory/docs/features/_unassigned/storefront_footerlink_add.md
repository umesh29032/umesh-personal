---
id: url-card-admin-storefront-footerlink-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_footerlink_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_footerlink_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_footerlink_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/footerlink/add/` |
| Pattern | `add/` |
| Named | true |
