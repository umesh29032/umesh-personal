---
id: url-card-admin-storefront-footerlink-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_footerlink_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_footerlink_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_footerlink_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/footerlink/<path:object_id>/change/` |
