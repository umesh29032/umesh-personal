---
id: url-card-admin-storefront-footerlink-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_footerlink_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_footerlink_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_footerlink_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/footerlink/` |
