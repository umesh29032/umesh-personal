---
id: url-card-admin-storefront-footerlink-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_footerlink_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_footerlink_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_footerlink_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/footerlink/<path:object_id>/history/` |
