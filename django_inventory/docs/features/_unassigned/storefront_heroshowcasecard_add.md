---
id: url-card-admin-storefront-heroshowcasecard-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_heroshowcasecard_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_heroshowcasecard_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_heroshowcasecard_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/heroshowcasecard/add/` |
| Pattern | `add/` |
| Named | true |
