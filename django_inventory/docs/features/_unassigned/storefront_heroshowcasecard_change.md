---
id: url-card-admin-storefront-heroshowcasecard-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_heroshowcasecard_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_heroshowcasecard_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_heroshowcasecard_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/heroshowcasecard/<path:object_id>/change/` |
