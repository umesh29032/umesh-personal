---
id: url-card-admin-storefront-heroshowcasecard-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_heroshowcasecard_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_heroshowcasecard_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_heroshowcasecard_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/heroshowcasecard/` |
