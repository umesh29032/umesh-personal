---
id: url-card-admin-storefront-heroshowcasecard-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_heroshowcasecard_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_heroshowcasecard_delete`
...
| Field | Value |
|---|---|
| URL name | `storefront_heroshowcasecard_delete` |
| Namespace | `admin` |
| Mount | `/admin/storefront/heroshowcasecard/<path:object_id>/delete/` |
