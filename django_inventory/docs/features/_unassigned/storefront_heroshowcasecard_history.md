---
id: url-card-admin-storefront-heroshowcasecard-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_heroshowcasecard_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_heroshowcasecard_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_heroshowcasecard_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/heroshowcasecard/<path:object_id>/history/` |
