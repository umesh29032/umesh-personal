---
id: url-card-admin-storefront-homepageconfig-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_homepageconfig_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_homepageconfig_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_homepageconfig_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/add/` |
| Pattern | `add/` |
| Named | true |
