---
id: url-card-admin-storefront-homepageconfig-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_homepageconfig_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_homepageconfig_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_homepageconfig_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/<path:object_id>/change/` |
