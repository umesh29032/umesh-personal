---
id: url-card-admin-storefront-homepageconfig-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_homepageconfig_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_homepageconfig_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_homepageconfig_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/` |
