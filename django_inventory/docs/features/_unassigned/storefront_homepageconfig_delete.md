---
id: url-card-admin-storefront-homepageconfig-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_homepageconfig_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_homepageconfig_delete`
...
| Field | Value |
|---|---|
| URL name | `storefront_homepageconfig_delete` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/<path:object_id>/delete/` |
