---
id: url-card-admin-storefront-homepageconfig-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_homepageconfig_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_homepageconfig_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_homepageconfig_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/homepageconfig/<path:object_id>/history/` |
