---
id: url-card-admin-storefront-navlink-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_navlink_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_navlink_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_navlink_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/add/` |
| Pattern | `add/` |
| Named | true |
