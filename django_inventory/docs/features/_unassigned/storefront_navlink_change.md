---
id: url-card-admin-storefront-navlink-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_navlink_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_navlink_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_navlink_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/<path:object_id>/change/` |
