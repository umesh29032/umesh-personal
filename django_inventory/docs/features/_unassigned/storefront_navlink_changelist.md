---
id: url-card-admin-storefront-navlink-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_navlink_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_navlink_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_navlink_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/` |
