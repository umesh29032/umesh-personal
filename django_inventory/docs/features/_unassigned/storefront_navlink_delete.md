---
id: url-card-admin-storefront-navlink-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_navlink_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_navlink_delete`
...
| Field | Value |
|---|---|
| URL name | `storefront_navlink_delete` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/<path:object_id>/delete/` |
