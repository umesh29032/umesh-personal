---
id: url-card-admin-storefront-navlink-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_navlink_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_navlink_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_navlink_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/navlink/<path:object_id>/history/` |
