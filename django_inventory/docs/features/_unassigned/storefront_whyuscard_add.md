---
id: url-card-admin-storefront-whyuscard-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_whyuscard_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_whyuscard_add`
...
| Field | Value |
|---|---|
| URL name | `storefront_whyuscard_add` |
| Namespace | `admin` |
| Mount | `/admin/storefront/whyuscard/add/` |
| Pattern | `add/` |
| Named | true |
