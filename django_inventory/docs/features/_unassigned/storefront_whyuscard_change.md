---
id: url-card-admin-storefront-whyuscard-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_whyuscard_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `storefront_whyuscard_change`
...
| Field | Value |
|---|---|
| URL name | `storefront_whyuscard_change` |
| Namespace | `admin` |
| Mount | `/admin/storefront/whyuscard/<path:object_id>/change/` |
