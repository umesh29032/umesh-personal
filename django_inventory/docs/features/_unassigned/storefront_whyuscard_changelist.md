---
id: url-card-admin-storefront-whyuscard-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_whyuscard_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_whyuscard_changelist`
...
| Field | Value |
|---|---|
| URL name | `storefront_whyuscard_changelist` |
| Namespace | `admin` |
| Mount | `/admin/storefront/whyuscard/` |
