---
id: url-card-admin-storefront-whyuscard-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:storefront_whyuscard_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `storefront_whyuscard_history`
...
| Field | Value |
|---|---|
| URL name | `storefront_whyuscard_history` |
| Namespace | `admin` |
| Mount | `/admin/storefront/whyuscard/<path:object_id>/history/` |
