---
id: url-card-patterns-ai-table-approve
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:table-approve
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `table-approve`
...
| Field | Value |
|---|---|
| URL name | `table-approve` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table/<int:pk>/approve/<int:cand>/` |
| Pattern | `table/<int:pk>/approve/<int:cand>/` |
| Named | true |
