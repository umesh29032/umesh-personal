---
id: url-card-patterns-ai-table-layout-archive
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:table-layout-archive
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `table-layout-archive`
...
| Field | Value |
|---|---|
| URL name | `table-layout-archive` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table/<int:pk>/layouts/<int:lid>/archive/` |
| Pattern | `table/<int:pk>/layouts/<int:lid>/archive/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingTableLayoutArchiveView` |
