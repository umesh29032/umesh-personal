---
id: url-card-patterns-ai-table-recipe
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:table-recipe
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `table-recipe`
...
| Field | Value |
|---|---|
| URL name | `table-recipe` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table/<int:pk>/recipe/` |
| Pattern | `table/<int:pk>/recipe/` |
| Named | true |
