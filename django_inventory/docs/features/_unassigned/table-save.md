---
id: url-card-patterns-ai-table-save
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:table-save
...
| Mount | `/patterns/table/<int:pk>/save/` |
| Pattern | `table/<int:pk>/save/` |
| Named | true |
