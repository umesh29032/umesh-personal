---
id: url-card-admin-tracking-addahistory-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_addahistory_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_addahistory_add`
...
| Field | Value |
|---|---|
| URL name | `tracking_addahistory_add` |
| Namespace | `admin` |
| Mount | `/admin/tracking/addahistory/add/` |
| Pattern | `add/` |
| Named | true |
