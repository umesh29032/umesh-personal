---
id: url-card-admin-tracking-addahistory-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_addahistory_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_addahistory_change`
...
| Field | Value |
|---|---|
| URL name | `tracking_addahistory_change` |
| Namespace | `admin` |
| Mount | `/admin/tracking/addahistory/<path:object_id>/change/` |
