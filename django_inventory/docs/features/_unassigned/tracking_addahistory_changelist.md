---
id: url-card-admin-tracking-addahistory-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_addahistory_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_addahistory_changelist`
...
| Field | Value |
|---|---|
| URL name | `tracking_addahistory_changelist` |
| Namespace | `admin` |
| Mount | `/admin/tracking/addahistory/` |
