---
id: url-card-admin-tracking-addahistory-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_addahistory_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_addahistory_history`
...
| Field | Value |
|---|---|
| URL name | `tracking_addahistory_history` |
| Namespace | `admin` |
| Mount | `/admin/tracking/addahistory/<path:object_id>/history/` |
