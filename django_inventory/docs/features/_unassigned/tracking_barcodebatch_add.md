---
id: url-card-admin-tracking-barcodebatch-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_barcodebatch_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_barcodebatch_add`
...
| Field | Value |
|---|---|
| URL name | `tracking_barcodebatch_add` |
| Namespace | `admin` |
| Mount | `/admin/tracking/barcodebatch/add/` |
| Pattern | `add/` |
| Named | true |
