---
id: url-card-admin-tracking-barcodebatch-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_barcodebatch_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_barcodebatch_change`
...
| Field | Value |
|---|---|
| URL name | `tracking_barcodebatch_change` |
| Namespace | `admin` |
| Mount | `/admin/tracking/barcodebatch/<path:object_id>/change/` |
