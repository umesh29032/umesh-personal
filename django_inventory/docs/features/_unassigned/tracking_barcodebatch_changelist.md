---
id: url-card-admin-tracking-barcodebatch-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_barcodebatch_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_barcodebatch_changelist`
...
| Field | Value |
|---|---|
| URL name | `tracking_barcodebatch_changelist` |
| Namespace | `admin` |
| Mount | `/admin/tracking/barcodebatch/` |
