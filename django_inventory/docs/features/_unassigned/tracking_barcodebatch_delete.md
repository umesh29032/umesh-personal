---
id: url-card-admin-tracking-barcodebatch-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_barcodebatch_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_barcodebatch_delete`
...
| Field | Value |
|---|---|
| URL name | `tracking_barcodebatch_delete` |
| Namespace | `admin` |
| Mount | `/admin/tracking/barcodebatch/<path:object_id>/delete/` |
