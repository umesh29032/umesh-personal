---
id: url-card-admin-tracking-barcodebatch-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_barcodebatch_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_barcodebatch_history`
...
| Field | Value |
|---|---|
| URL name | `tracking_barcodebatch_history` |
| Namespace | `admin` |
| Mount | `/admin/tracking/barcodebatch/<path:object_id>/history/` |
