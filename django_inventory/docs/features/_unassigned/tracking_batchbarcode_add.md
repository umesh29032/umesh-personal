---
id: url-card-admin-tracking-batchbarcode-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_batchbarcode_add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_batchbarcode_add`
...
| Field | Value |
|---|---|
| URL name | `tracking_batchbarcode_add` |
| Namespace | `admin` |
| Mount | `/admin/tracking/batchbarcode/add/` |
| Pattern | `add/` |
| Named | true |
