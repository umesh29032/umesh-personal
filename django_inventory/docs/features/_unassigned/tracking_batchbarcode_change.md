---
id: url-card-admin-tracking-batchbarcode-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_batchbarcode_change
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_batchbarcode_change`
...
| Field | Value |
|---|---|
| URL name | `tracking_batchbarcode_change` |
| Namespace | `admin` |
| Mount | `/admin/tracking/batchbarcode/<path:object_id>/change/` |
