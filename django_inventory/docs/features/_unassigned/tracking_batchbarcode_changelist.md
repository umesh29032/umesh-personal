---
id: url-card-admin-tracking-batchbarcode-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_batchbarcode_changelist
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_batchbarcode_changelist`
...
| Field | Value |
|---|---|
| URL name | `tracking_batchbarcode_changelist` |
| Namespace | `admin` |
| Mount | `/admin/tracking/batchbarcode/` |
