---
id: url-card-admin-tracking-batchbarcode-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_batchbarcode_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_batchbarcode_delete`
...
| Field | Value |
|---|---|
| URL name | `tracking_batchbarcode_delete` |
| Namespace | `admin` |
| Mount | `/admin/tracking/batchbarcode/<path:object_id>/delete/` |
