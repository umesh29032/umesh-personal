---
id: url-card-admin-tracking-batchbarcode-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_batchbarcode_history
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_batchbarcode_history`
...
| Field | Value |
|---|---|
| URL name | `tracking_batchbarcode_history` |
| Namespace | `admin` |
| Mount | `/admin/tracking/batchbarcode/<path:object_id>/history/` |
