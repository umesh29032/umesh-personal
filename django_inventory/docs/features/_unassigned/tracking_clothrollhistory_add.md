---
id: url-card-admin-tracking-clothrollhistory-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_clothrollhistory_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_clothrollhistory_add`
...
| Field | Value |
|---|---|
| URL name | `tracking_clothrollhistory_add` |
| Namespace | `admin` |
| Mount | `/admin/tracking/clothrollhistory/add/` |
| Pattern | `add/` |
| Named | true |
