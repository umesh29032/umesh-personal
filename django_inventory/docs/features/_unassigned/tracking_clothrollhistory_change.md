---
id: url-card-admin-tracking-clothrollhistory-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_clothrollhistory_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_clothrollhistory_change`
...
| Field | Value |
|---|---|
| URL name | `tracking_clothrollhistory_change` |
| Namespace | `admin` |
| Mount | `/admin/tracking/clothrollhistory/<path:object_id>/change/` |
