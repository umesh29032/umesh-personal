---
id: url-card-admin-tracking-clothrollhistory-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_clothrollhistory_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_clothrollhistory_changelist`
...
| Field | Value |
|---|---|
| URL name | `tracking_clothrollhistory_changelist` |
| Namespace | `admin` |
| Mount | `/admin/tracking/clothrollhistory/` |
