---
id: url-card-admin-tracking-clothrollhistory-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_clothrollhistory_delete
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_clothrollhistory_delete`
...
| Field | Value |
|---|---|
| URL name | `tracking_clothrollhistory_delete` |
| Namespace | `admin` |
| Mount | `/admin/tracking/clothrollhistory/<path:object_id>/delete/` |
