---
id: url-card-admin-tracking-producthistory-add
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_producthistory_add
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_producthistory_add`
...
| Field | Value |
|---|---|
| URL name | `tracking_producthistory_add` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/add/` |
| Pattern | `add/` |
| Named | true |
