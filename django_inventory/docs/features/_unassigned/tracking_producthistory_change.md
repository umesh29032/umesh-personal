---
id: url-card-admin-tracking-producthistory-change
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_producthistory_change
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_producthistory_change`
...
| Field | Value |
|---|---|
| URL name | `tracking_producthistory_change` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/<path:object_id>/change/` |
