---
id: url-card-admin-tracking-producthistory-changelist
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_producthistory_changelist
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_producthistory_changelist`
...
| Field | Value |
|---|---|
| URL name | `tracking_producthistory_changelist` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/` |
