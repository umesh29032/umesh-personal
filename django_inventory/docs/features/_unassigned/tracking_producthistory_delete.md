---
id: url-card-admin-tracking-producthistory-delete
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_producthistory_delete
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `tracking_producthistory_delete`
...
| Field | Value |
|---|---|
| URL name | `tracking_producthistory_delete` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/<path:object_id>/delete/` |
