---
id: url-card-admin-tracking-producthistory-history
type: url-card
status: generated
owner: generated
scope: route — url:admin:tracking_producthistory_history
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `tracking_producthistory_history`
...
| Field | Value |
|---|---|
| URL name | `tracking_producthistory_history` |
| Namespace | `admin` |
| Mount | `/admin/tracking/producthistory/<path:object_id>/history/` |
