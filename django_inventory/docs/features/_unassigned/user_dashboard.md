---
id: url-card-inventory-user-dashboard
type: url-card
status: generated
owner: generated
scope: route — url:inventory:user_dashboard
anchors: config/config/urls.py
verified: graph:56207d76ed26
---

# URL card — `user_dashboard`
...
| Namespace | `inventory` |
| Mount | `/inventory/my-dashboard/legacy/` |
| Pattern | `my-dashboard/legacy/` |
| Named | true |
