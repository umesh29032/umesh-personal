---
id: url-card-admin-view-on-site
type: url-card
status: generated
owner: generated
scope: route — url:admin:view_on_site
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `view_on_site`
...
| Field | Value |
|---|---|
| URL name | `view_on_site` |
| Namespace | `admin` |
| Mount | `/admin/r/<int:content_type_id>/<path:object_id>/` |
...
| Defined in | `/admin/r/<int:content_type_id>/<path:object_id>/` |
| Vendor | true |
