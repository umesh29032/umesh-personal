---
id: url-card-expense-worker-pay-basis
type: url-card
status: generated
owner: generated
scope: route — url:expense:worker-pay-basis
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `worker-pay-basis`
...
| Field | Value |
|---|---|
| URL name | `worker-pay-basis` |
| Namespace | `expense` |
| Mount | `/expense/workers/<int:pk>/pay-basis/` |
| Pattern | `workers/<int:pk>/pay-basis/` |
| Named | true |
