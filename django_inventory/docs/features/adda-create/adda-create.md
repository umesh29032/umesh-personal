---
id: url-card-production-adda-create
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-create
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `adda-create`
...
| Field | Value |
|---|---|
| URL name | `adda-create` |
| Namespace | `production` |
| Mount | `/production/addas/start/` |
| Pattern | `addas/start/` |
| Named | true |
...
[Adda create](README.md) (`adda-create`, via `belongs_to_feature`)
