---
id: url-card-production-adda-add-lane
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-add-lane
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `adda-add-lane`
...
| Field | Value |
|---|---|
| URL name | `adda-add-lane` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/lanes/add/` |
| Pattern | `addas/<str:code>/lanes/add/` |
| Named | true |
