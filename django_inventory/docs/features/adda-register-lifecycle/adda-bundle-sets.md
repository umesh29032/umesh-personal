---
id: url-card-production-adda-bundle-sets
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-bundle-sets
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `adda-bundle-sets`
...
| Field | Value |
|---|---|
| URL name | `adda-bundle-sets` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/bundles/create-sets/` |
| Pattern | `addas/<str:code>/bundles/create-sets/` |
| Named | true |
...
[Adda register + lifecycle (list · detail · lanes · cancel · delete)](README.md) (`adda-register-lifecycle`, via `belongs_to_feature`)
