---
id: url-card-production-adda-cancel-lane
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-cancel-lane
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `adda-cancel-lane`
...
| Field | Value |
|---|---|
| URL name | `adda-cancel-lane` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/lanes/cancel/` |
| Pattern | `addas/<str:code>/lanes/cancel/` |
| Named | true |
