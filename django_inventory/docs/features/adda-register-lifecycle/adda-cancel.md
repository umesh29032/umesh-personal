---
id: url-card-production-adda-cancel
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-cancel
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `adda-cancel`
...
| Field | Value |
|---|---|
| URL name | `adda-cancel` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cancel/` |
| Pattern | `addas/<str:code>/cancel/` |
| Named | true |
