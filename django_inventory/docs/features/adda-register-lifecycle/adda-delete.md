---
id: url-card-production-adda-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `adda-delete`
...
| Field | Value |
|---|---|
| URL name | `adda-delete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/delete/` |
| Pattern | `addas/<str:code>/delete/` |
| Named | true |
