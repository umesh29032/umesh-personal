...
|---|---|---|---|
| `expense:advance-add` | `/expense/advances/add/` | `AdvanceCreateView` | [advance-add.md](advance-add.md) |

## Member models

| Model | Table | Single writer |
|---|---|---|
| `expense.WorkerAdvance` | `expense_workeradvance` | not machine-known |
