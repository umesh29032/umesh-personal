---
id: url-card-expense-advance-add
type: url-card
status: generated
owner: generated
scope: route — url:expense:advance-add
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `advance-add`
...
| Field | Value |
|---|---|
| URL name | `advance-add` |
| Namespace | `expense` |
| Mount | `/expense/advances/add/` |
| Pattern | `advances/add/` |
| Named | true |
...
[Advance](README.md) (`advance`, via `belongs_to_feature`)
