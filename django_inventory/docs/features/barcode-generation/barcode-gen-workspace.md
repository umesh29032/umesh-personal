---
id: url-card-production-barcode-gen-workspace
type: url-card
status: generated
owner: generated
scope: route — url:production:barcode-gen-workspace
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `barcode-gen-workspace`
...
| Field | Value |
|---|---|
| URL name | `barcode-gen-workspace` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/barcode-gen/` |
| Pattern | `addas/<str:code>/barcode-gen/` |
| Named | true |
