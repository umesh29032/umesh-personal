---
id: url-card-raw-materials-cloth-color-archive
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-color-archive
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cloth-color-archive`
...
| Field | Value |
|---|---|
| URL name | `cloth-color-archive` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-colors/<int:pk>/archive/` |
| Pattern | `cloth-colors/<int:pk>/archive/` |
| Named | true |
