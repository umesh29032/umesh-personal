---
id: url-card-raw-materials-cloth-color-list
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-color-list
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cloth-color-list`
...
| Field | Value |
|---|---|
| URL name | `cloth-color-list` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-colors/` |
| Pattern | `cloth-colors/` |
| Named | true |
