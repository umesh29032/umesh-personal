---
id: url-card-raw-materials-cloth-color-update
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-color-update
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cloth-color-update`
...
| Field | Value |
|---|---|
| URL name | `cloth-color-update` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-colors/<int:pk>/edit/` |
| Pattern | `cloth-colors/<int:pk>/edit/` |
| Named | true |
