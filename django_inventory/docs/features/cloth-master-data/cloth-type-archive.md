---
id: url-card-raw-materials-cloth-type-archive
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-type-archive
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cloth-type-archive`
...
| Field | Value |
|---|---|
| URL name | `cloth-type-archive` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-types/<int:pk>/archive/` |
| Pattern | `cloth-types/<int:pk>/archive/` |
| Named | true |
