---
id: url-card-raw-materials-cloth-type-delete
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-type-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cloth-type-delete`
...
| Field | Value |
|---|---|
| URL name | `cloth-type-delete` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-types/<int:pk>/delete/` |
| Pattern | `cloth-types/<int:pk>/delete/` |
| Named | true |
