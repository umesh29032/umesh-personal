---
id: url-card-raw-materials-cloth-type-list
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-type-list
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cloth-type-list`
...
| Field | Value |
|---|---|
| URL name | `cloth-type-list` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth-types/` |
| Pattern | `cloth-types/` |
| Named | true |
