---
id: url-card-raw-materials-storage-archive
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:storage-archive
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `storage-archive`
...
| Field | Value |
|---|---|
| URL name | `storage-archive` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/storage-locations/<int:pk>/archive/` |
| Pattern | `storage-locations/<int:pk>/archive/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `StorageLocationArchiveView` |
