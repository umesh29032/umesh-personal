---
id: url-card-raw-materials-storage-delete
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:storage-delete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `storage-delete`
...
| Field | Value |
|---|---|
| URL name | `storage-delete` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/storage-locations/<int:pk>/delete/` |
| Pattern | `storage-locations/<int:pk>/delete/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `StorageLocationDeleteView` |
