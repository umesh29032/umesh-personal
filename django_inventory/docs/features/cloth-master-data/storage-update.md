---
id: url-card-raw-materials-storage-update
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:storage-update
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `storage-update`
...
| Field | Value |
|---|---|
| URL name | `storage-update` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/storage-locations/<int:pk>/edit/` |
| Pattern | `storage-locations/<int:pk>/edit/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `StorageLocationUpdateView` |
