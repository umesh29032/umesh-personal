---
id: feature-costing-dashboard
type: feature-doc
status: generated
owner: generated
scope: feature — costing-dashboard
anchors: docs/LEARNING_2_0/PROJECT_BRAIN/FEATURE_INDEX.md
verified: graph:5d159ece1df0
---

# Feature — Costing dashboard
...
|---|---|---|---|
| `production:costing` | `/production/costing/` | `ProductionCostingView` | [costing.md](costing.md) |
