---
id: url-card-production-costing
type: url-card
status: generated
owner: generated
scope: route — url:production:costing
...
| Field | Value |
|---|---|
| View | `ProductionCostingView` |
| Module | `production.views.costing_views` |
| Defined in | `config/production/views/costing_views.py` |
| Vendor | false |

## App

Derived from the view module (`production.views.costing_views` → app `production`; a render rule, not a graph edge).
...
[Costing dashboard](README.md) (`costing-dashboard`, via `belongs_to_feature`)
