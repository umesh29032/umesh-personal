---
id: url-card-production-pattern-complete
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-complete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-complete`
...
| Field | Value |
|---|---|
| URL name | `pattern-complete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/complete/` |
| Pattern | `addas/<str:code>/pattern/complete/` |
| Named | true |
