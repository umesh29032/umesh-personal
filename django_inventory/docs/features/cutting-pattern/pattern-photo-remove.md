---
id: url-card-production-pattern-photo-remove
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-photo-remove
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `pattern-photo-remove`
...
| Field | Value |
|---|---|
| URL name | `pattern-photo-remove` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/photos/<int:pk>/remove/` |
| Pattern | `addas/<str:code>/pattern/photos/<int:pk>/remove/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `PatternRemovePhotoView` |
| Module | `production.views.pattern_stage_views` |
| Defined in | `config/production/views/pattern_stage_views.py` |
| Vendor | false |

## App

Derived from the view module (`production.views.pattern_stage_views` → app `production`; a render rule, not a graph edge).
...
[Cutting-pattern (display: "Pattern Design" — stage-trio spec 2026-07-05)](README.md) (`cutting-pattern`, via `belongs_to_feature`)
