---
id: url-card-production-pattern-photos-add
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-photos-add
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `pattern-photos-add`
...
| Field | Value |
|---|---|
| URL name | `pattern-photos-add` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/photos/add/` |
| Pattern | `addas/<str:code>/pattern/photos/add/` |
| Named | true |
