---
id: url-card-production-pattern-reopen
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-reopen
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `pattern-reopen`
...
| Field | Value |
|---|---|
| URL name | `pattern-reopen` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/reopen/` |
| Pattern | `addas/<str:code>/pattern/reopen/` |
| Named | true |
