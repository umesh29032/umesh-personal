---
id: url-card-production-pattern-save
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-save
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-save`
...
| Field | Value |
|---|---|
| URL name | `pattern-save` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/save/` |
| Pattern | `addas/<str:code>/pattern/save/` |
| Named | true |
