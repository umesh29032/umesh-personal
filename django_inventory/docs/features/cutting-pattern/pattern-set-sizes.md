---
id: url-card-production-pattern-set-sizes
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-set-sizes
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-set-sizes`
...
| Field | Value |
|---|---|
| URL name | `pattern-set-sizes` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/sizes/` |
| Pattern | `addas/<str:code>/pattern/sizes/` |
| Named | true |
