---
id: url-card-production-pattern-start
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-start
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-start`
...
| Field | Value |
|---|---|
| URL name | `pattern-start` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/start/` |
| Pattern | `addas/<str:code>/pattern/start/` |
| Named | true |
