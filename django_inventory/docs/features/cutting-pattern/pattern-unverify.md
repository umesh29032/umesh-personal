---
id: url-card-production-pattern-unverify
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-unverify
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-unverify`
...
| Field | Value |
|---|---|
| URL name | `pattern-unverify` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/unverify/` |
| Pattern | `addas/<str:code>/pattern/unverify/` |
| Named | true |
