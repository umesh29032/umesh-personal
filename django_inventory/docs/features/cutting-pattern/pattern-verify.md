---
id: url-card-production-pattern-verify
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-verify
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `pattern-verify`
...
| Field | Value |
|---|---|
| URL name | `pattern-verify` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/verify/` |
| Pattern | `addas/<str:code>/pattern/verify/` |
| Named | true |
