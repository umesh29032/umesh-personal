---
id: url-card-production-pattern-workspace
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-workspace
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pattern-workspace`
...
| Field | Value |
|---|---|
| URL name | `pattern-workspace` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/pattern/` |
| Pattern | `addas/<str:code>/pattern/` |
| Named | true |
