---
id: url-card-production-cutting-allocation-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-allocation-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-allocation-delete`
...
| Field | Value |
|---|---|
| URL name | `cutting-allocation-delete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/allocation/<int:pk>/delete/` |
| Pattern | `addas/<str:code>/cutting/allocation/<int:pk>/delete/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingAllocationDeleteView` |
