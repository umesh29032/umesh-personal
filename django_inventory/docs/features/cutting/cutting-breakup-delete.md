---
id: url-card-production-cutting-breakup-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-breakup-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-breakup-delete`
...
| Field | Value |
|---|---|
| URL name | `cutting-breakup-delete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/breakup/<int:pk>/delete/` |
| Pattern | `addas/<str:code>/cutting/breakup/<int:pk>/delete/` |
| Named | true |
