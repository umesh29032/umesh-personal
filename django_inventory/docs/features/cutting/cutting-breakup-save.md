---
id: url-card-production-cutting-breakup-save
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-breakup-save
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cutting-breakup-save`
...
| Field | Value |
|---|---|
| URL name | `cutting-breakup-save` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/breakup/save/` |
| Pattern | `addas/<str:code>/cutting/breakup/save/` |
| Named | true |
