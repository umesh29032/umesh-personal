---
id: url-card-production-cutting-bundle-add-pieces
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-bundle-add-pieces
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cutting-bundle-add-pieces`
...
| Field | Value |
|---|---|
| URL name | `cutting-bundle-add-pieces` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/bundle/<int:pk>/add-pieces/` |
| Pattern | `addas/<str:code>/cutting/bundle/<int:pk>/add-pieces/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingBundleAddPiecesView` |
