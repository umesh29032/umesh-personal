---
id: url-card-production-cutting-bundle-create
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-bundle-create
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-bundle-create`
...
| Field | Value |
|---|---|
| URL name | `cutting-bundle-create` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/bundle/create/` |
| Pattern | `addas/<str:code>/cutting/bundle/create/` |
| Named | true |
