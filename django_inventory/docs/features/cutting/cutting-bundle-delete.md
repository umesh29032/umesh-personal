---
id: url-card-production-cutting-bundle-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-bundle-delete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cutting-bundle-delete`
...
| Field | Value |
|---|---|
| URL name | `cutting-bundle-delete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/bundle/<int:pk>/delete/` |
| Pattern | `addas/<str:code>/cutting/bundle/<int:pk>/delete/` |
| Named | true |
