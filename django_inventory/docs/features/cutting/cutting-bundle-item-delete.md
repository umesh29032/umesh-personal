---
id: url-card-production-cutting-bundle-item-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-bundle-item-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-bundle-item-delete`
...
| Field | Value |
|---|---|
| URL name | `cutting-bundle-item-delete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/bundle/item/<int:pk>/delete/` |
| Pattern | `addas/<str:code>/cutting/bundle/item/<int:pk>/delete/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingBundleItemDeleteView` |
...
[Cutting](README.md) (`cutting`, via `belongs_to_feature`)
