---
id: url-card-production-cutting-complete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-complete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-complete`
...
| Field | Value |
|---|---|
| URL name | `cutting-complete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/` |
| Pattern | `addas/<str:code>/cutting/` |
| Named | true |
