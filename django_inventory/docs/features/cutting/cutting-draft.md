---
id: url-card-production-cutting-draft
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-draft
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cutting-draft`
...
| Field | Value |
|---|---|
| URL name | `cutting-draft` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/draft/` |
| Pattern | `addas/<str:code>/cutting/draft/` |
| Named | true |
