---
id: url-card-production-cutting-item-allocate
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-item-allocate
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-item-allocate`
...
| Field | Value |
|---|---|
| URL name | `cutting-item-allocate` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/bundle/item/<int:pk>/allocate/` |
| Pattern | `addas/<str:code>/cutting/bundle/item/<int:pk>/allocate/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingBundleItemAllocateView` |
