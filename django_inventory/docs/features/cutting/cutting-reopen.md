---
id: url-card-production-cutting-reopen
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-reopen
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `cutting-reopen`
...
| Field | Value |
|---|---|
| URL name | `cutting-reopen` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/reopen/` |
| Pattern | `addas/<str:code>/cutting/reopen/` |
| Named | true |
