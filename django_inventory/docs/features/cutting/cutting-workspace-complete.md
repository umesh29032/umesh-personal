---
id: url-card-production-cutting-workspace-complete
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-workspace-complete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-workspace-complete`
...
| Field | Value |
|---|---|
| URL name | `cutting-workspace-complete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/workspace/complete/` |
| Pattern | `addas/<str:code>/cutting/workspace/complete/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `CuttingWorkspaceCompleteView` |
