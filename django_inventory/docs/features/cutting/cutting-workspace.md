---
id: url-card-production-cutting-workspace
type: url-card
status: generated
owner: generated
scope: route — url:production:cutting-workspace
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-workspace`
...
| Field | Value |
|---|---|
| URL name | `cutting-workspace` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/cutting/workspace/` |
| Pattern | `addas/<str:code>/cutting/workspace/` |
| Named | true |
