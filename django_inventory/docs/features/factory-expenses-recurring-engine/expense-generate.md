---
id: url-card-expense-expense-generate
type: url-card
status: generated
owner: generated
scope: route — url:expense:expense-generate
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `expense-generate`
...
| Field | Value |
|---|---|
| URL name | `expense-generate` |
| Namespace | `expense` |
| Mount | `/expense/generate/` |
| Pattern | `generate/` |
| Named | true |
