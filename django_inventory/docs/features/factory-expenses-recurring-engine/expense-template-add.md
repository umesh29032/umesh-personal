---
id: url-card-expense-expense-template-add
type: url-card
status: generated
owner: generated
scope: route — url:expense:expense-template-add
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `expense-template-add`
...
| Field | Value |
|---|---|
| URL name | `expense-template-add` |
| Namespace | `expense` |
| Mount | `/expense/templates/add/` |
...
| Field | Value |
|---|---|
| View | `ExpenseTemplateCreateView` |
...
[Factory expenses + recurring engine (record · register · generate · material spend)](README.md) (`factory-expenses-recurring-engine`, via `belongs_to_feature`)
