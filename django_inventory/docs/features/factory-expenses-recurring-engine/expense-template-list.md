---
id: url-card-expense-expense-template-list
type: url-card
status: generated
owner: generated
scope: route — url:expense:expense-template-list
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `expense-template-list`
...
| Field | Value |
|---|---|
| URL name | `expense-template-list` |
| Namespace | `expense` |
| Mount | `/expense/templates/` |
| Pattern | `templates/` |
| Named | true |
