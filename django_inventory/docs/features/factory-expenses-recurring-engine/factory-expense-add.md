---
id: url-card-expense-factory-expense-add
type: url-card
status: generated
owner: generated
scope: route — url:expense:factory-expense-add
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `factory-expense-add`
...
| Field | Value |
|---|---|
| URL name | `factory-expense-add` |
| Namespace | `expense` |
| Mount | `/expense/expenses/add/` |
