---
id: url-card-expense-factory-expense-list
type: url-card
status: generated
owner: generated
scope: route — url:expense:factory-expense-list
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `factory-expense-list`
...
| Field | Value |
|---|---|
| URL name | `factory-expense-list` |
| Namespace | `expense` |
| Mount | `/expense/expenses/` |
| Pattern | `expenses/` |
| Named | true |
