---
id: url-card-expense-material-spend
type: url-card
status: generated
owner: generated
scope: route — url:expense:material-spend
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `material-spend`
...
| Field | Value |
|---|---|
| URL name | `material-spend` |
| Namespace | `expense` |
| Mount | `/expense/material-spend/` |
| Pattern | `material-spend/` |
| Named | true |
