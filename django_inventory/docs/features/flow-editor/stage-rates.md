---
id: url-card-production-stage-rates
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-rates
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `stage-rates`
...
| Field | Value |
|---|---|
| URL name | `stage-rates` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage-rates/` |
| Pattern | `addas/<str:code>/stage-rates/` |
| Named | true |
