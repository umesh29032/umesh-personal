---
id: url-card-production-layering-attach-roll
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-attach-roll
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `layering-attach-roll`
...
| Field | Value |
|---|---|
| URL name | `layering-attach-roll` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/attach-roll/` |
| Pattern | `addas/<str:code>/layering/attach-roll/` |
| Named | true |
