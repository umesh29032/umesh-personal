---
id: url-card-production-layering-complete
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-complete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `layering-complete`
...
| Field | Value |
|---|---|
| URL name | `layering-complete` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/complete/` |
| Pattern | `addas/<str:code>/layering/complete/` |
| Named | true |
