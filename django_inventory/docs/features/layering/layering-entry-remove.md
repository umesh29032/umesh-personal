---
id: url-card-production-layering-entry-remove
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-entry-remove
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `layering-entry-remove`
...
| Field | Value |
|---|---|
| URL name | `layering-entry-remove` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/entries/<int:pk>/remove/` |
| Pattern | `addas/<str:code>/layering/entries/<int:pk>/remove/` |
| Named | true |
