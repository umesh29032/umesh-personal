---
id: url-card-production-layering-quick-create-roll
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-quick-create-roll
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `layering-quick-create-roll`
...
| Field | Value |
|---|---|
| URL name | `layering-quick-create-roll` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/quick-create-roll/` |
| Pattern | `addas/<str:code>/layering/quick-create-roll/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `LayeringQuickCreateAndAttachView` |
...
[Layering](README.md) (`layering`, via `belongs_to_feature`)
