---
id: url-card-production-layering-reopen
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-reopen
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `layering-reopen`
...
| Field | Value |
|---|---|
| URL name | `layering-reopen` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/reopen/` |
| Pattern | `addas/<str:code>/layering/reopen/` |
| Named | true |
