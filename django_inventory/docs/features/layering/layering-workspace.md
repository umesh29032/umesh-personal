---
id: url-card-production-layering-workspace
type: url-card
status: generated
owner: generated
scope: route — url:production:layering-workspace
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `layering-workspace`
...
| Field | Value |
|---|---|
| URL name | `layering-workspace` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/layering/` |
| Pattern | `addas/<str:code>/layering/` |
| Named | true |
