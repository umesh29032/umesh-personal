---
id: url-card-learning-toggle-bookmark
type: url-card
status: generated
owner: generated
scope: route — url:learning:toggle-bookmark
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `toggle-bookmark`
...
| Field | Value |
|---|---|
| URL name | `toggle-bookmark` |
| Namespace | `learning` |
| Mount | `/learn/<slug:course>/<slug:chapter>/bookmark/` |
| Pattern | `<slug:course>/<slug:chapter>/bookmark/` |
| Named | true |
