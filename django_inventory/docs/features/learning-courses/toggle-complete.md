---
id: url-card-learning-toggle-complete
type: url-card
status: generated
owner: generated
scope: route — url:learning:toggle-complete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `toggle-complete`
...
| Field | Value |
|---|---|
| URL name | `toggle-complete` |
| Namespace | `learning` |
| Mount | `/learn/<slug:course>/<slug:chapter>/complete/` |
| Pattern | `<slug:course>/<slug:chapter>/complete/` |
| Named | true |
