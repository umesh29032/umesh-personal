---
id: url-card-accounts-reset-password-verify
type: url-card
status: generated
owner: generated
scope: route — url:accounts:reset_password_verify
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `reset_password_verify`
...
| Field | Value |
|---|---|
| URL name | `reset_password_verify` |
| Namespace | `accounts` |
| Mount | `/app/reset-password/verify/` |
...
[Login (OTP/password)](README.md) (`login`, via `belongs_to_feature`)
