---
id: url-card-production-generic-stage-alloc-void
type: url-card
status: generated
owner: generated
scope: route — url:production:generic-stage-alloc-void
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `generic-stage-alloc-void`
...
| Field | Value |
|---|---|
| URL name | `generic-stage-alloc-void` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage/<str:stage_type>/alloc-void/` |
| Pattern | `addas/<str:code>/stage/<str:stage_type>/alloc-void/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `GenericStageAllocationVoidView` |
