---
id: url-card-production-generic-stage-start
type: url-card
status: generated
owner: generated
scope: route — url:production:generic-stage-start
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `generic-stage-start`
...
| Field | Value |
|---|---|
| URL name | `generic-stage-start` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/stage/<str:stage_type>/start/` |
| Pattern | `addas/<str:code>/stage/<str:stage_type>/start/` |
| Named | true |
