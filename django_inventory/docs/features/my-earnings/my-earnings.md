---
id: url-card-expense-my-earnings
type: url-card
status: generated
owner: generated
scope: route — url:expense:my-earnings
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `my-earnings`
...
[My Earnings (worker)](README.md) (`my-earnings`, via `belongs_to_feature`)
