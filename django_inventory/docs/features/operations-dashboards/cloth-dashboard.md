---
id: url-card-raw-materials-cloth-dashboard
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:cloth-dashboard
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cloth-dashboard`
...
| Field | Value |
|---|---|
| URL name | `cloth-dashboard` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/cloth/` |
| Pattern | `cloth/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `ClothDashboardView` |
| Module | `raw_materials.views.dashboard` |
| Defined in | `config/raw_materials/views/dashboard.py` |
| Vendor | false |

## App

Derived from the view module (`raw_materials.views.dashboard` → app `raw_materials`; a render rule, not a graph edge).
