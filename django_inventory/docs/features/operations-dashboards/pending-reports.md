---
id: url-card-production-pending-reports
type: url-card
status: generated
owner: generated
scope: route — url:production:pending-reports
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `pending-reports`
...
| Field | Value |
|---|---|
| URL name | `pending-reports` |
| Namespace | `production` |
| Mount | `/production/pending-reports/` |
| Pattern | `pending-reports/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `PendingReportListView` |
| Module | `production.views.dashboard` |
| Defined in | `config/production/views/dashboard.py` |
| Vendor | false |

## App

Derived from the view module (`production.views.dashboard` → app `production`; a render rule, not a graph edge).
