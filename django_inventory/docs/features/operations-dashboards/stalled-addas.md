---
id: url-card-production-stalled-addas
type: url-card
status: generated
owner: generated
scope: route — url:production:stalled-addas
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `stalled-addas`
...
| Field | Value |
|---|---|
| URL name | `stalled-addas` |
| Namespace | `production` |
| Mount | `/production/stalled/` |
| Pattern | `stalled/` |
| Named | true |
