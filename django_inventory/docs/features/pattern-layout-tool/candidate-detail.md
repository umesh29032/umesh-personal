---
id: url-card-patterns-ai-candidate-detail
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:candidate-detail
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `candidate-detail`
...
| Field | Value |
|---|---|
| URL name | `candidate-detail` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/candidates/<int:pk>/` |
| Pattern | `candidates/<int:pk>/` |
| Named | true |
