---
id: url-card-patterns-ai-candidate-svg
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:candidate-svg
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `candidate-svg`
...
| Field | Value |
|---|---|
| URL name | `candidate-svg` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/candidates/<int:pk>/svg/` |
| Pattern | `candidates/<int:pk>/svg/` |
| Named | true |
