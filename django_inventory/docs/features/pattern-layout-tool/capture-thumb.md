---
id: url-card-patterns-ai-capture-thumb
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:capture-thumb
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `capture-thumb`
...
| Field | Value |
|---|---|
| URL name | `capture-thumb` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/captures/<int:pk>/thumb/` |
| Pattern | `captures/<int:pk>/thumb/` |
| Named | true |
