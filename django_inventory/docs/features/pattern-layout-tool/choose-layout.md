---
id: url-card-patterns-ai-choose-layout
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:choose-layout
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `choose-layout`
...
| Field | Value |
|---|---|
| URL name | `choose-layout` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table-usage/<int:pk>/` |
| Pattern | `table-usage/<int:pk>/` |
| Named | true |
