---
id: url-card-patterns-ai-cutting-table
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:cutting-table
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `cutting-table`
...
| Field | Value |
|---|---|
| URL name | `cutting-table` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/table/<int:pk>/` |
| Pattern | `table/<int:pk>/` |
| Named | true |
