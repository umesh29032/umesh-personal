---
id: url-card-patterns-ai-geometry-svg
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:geometry-svg
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `geometry-svg`
...
| Field | Value |
|---|---|
| URL name | `geometry-svg` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/geometry/<int:pk>/svg/` |
| Pattern | `geometry/<int:pk>/svg/` |
| Named | true |
