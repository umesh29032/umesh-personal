---
id: url-card-patterns-ai-marker-detail
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:marker-detail
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `marker-detail`
...
| Field | Value |
|---|---|
| URL name | `marker-detail` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/markers/<str:reference>/` |
| Pattern | `markers/<str:reference>/` |
| Named | true |
