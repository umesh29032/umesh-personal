---
id: url-card-patterns-ai-mat-recheck
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:mat-recheck
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `mat-recheck`
...
| Field | Value |
|---|---|
| URL name | `mat-recheck` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/mats/<int:pk>/recheck/` |
| Pattern | `mats/<int:pk>/recheck/` |
| Named | true |
