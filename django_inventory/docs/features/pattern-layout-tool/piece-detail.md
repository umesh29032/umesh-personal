---
id: url-card-patterns-ai-piece-detail
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:piece-detail
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `piece-detail`
...
| Field | Value |
|---|---|
| URL name | `piece-detail` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/pieces/<int:pk>/` |
| Pattern | `pieces/<int:pk>/` |
| Named | true |
