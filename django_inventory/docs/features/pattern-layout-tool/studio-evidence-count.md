---
id: url-card-patterns-ai-studio-evidence-count
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:studio-evidence-count
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `studio-evidence-count`
...
| Field | Value |
|---|---|
| URL name | `studio-evidence-count` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/studio/work/<int:piece_pk>/<int:size_pk>/evidence-count/` |
| Pattern | `studio/work/<int:piece_pk>/<int:size_pk>/evidence-count/` |
| Named | true |
