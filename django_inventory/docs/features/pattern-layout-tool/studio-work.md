---
id: url-card-patterns-ai-studio-work
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:studio-work
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `studio-work`
...
| Field | Value |
|---|---|
| URL name | `studio-work` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/studio/work/<int:piece_pk>/<int:size_pk>/` |
| Pattern | `studio/work/<int:piece_pk>/<int:size_pk>/` |
| Named | true |
