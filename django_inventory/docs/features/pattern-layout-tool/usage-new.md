---
id: url-card-patterns-ai-usage-new
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:usage-new
...
| Mount | `/patterns/markers/<str:reference>/usage/new/` |
| Pattern | `markers/<str:reference>/usage/new/` |
| Named | true |
