---
id: url-card-patterns-ai-usage-void
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:usage-void
...
| Mount | `/patterns/usages/<int:pk>/void/` |
| Pattern | `usages/<int:pk>/void/` |
| Named | true |
