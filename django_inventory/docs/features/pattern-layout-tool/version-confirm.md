---
id: url-card-patterns-ai-version-confirm
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:version-confirm
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `version-confirm`
...
| Field | Value |
|---|---|
| URL name | `version-confirm` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/versions/<int:pk>/confirm/` |
| Pattern | `versions/<int:pk>/confirm/` |
| Named | true |
