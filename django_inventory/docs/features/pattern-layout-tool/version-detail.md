---
id: url-card-patterns-ai-version-detail
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:version-detail
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `version-detail`
...
| Field | Value |
|---|---|
| URL name | `version-detail` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/versions/<int:pk>/` |
| Pattern | `versions/<int:pk>/` |
| Named | true |
