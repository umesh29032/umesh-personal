---
id: url-card-patterns-ai-version-next
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:version-next
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `version-next`
...
| Field | Value |
|---|---|
| URL name | `version-next` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/pieces/<int:pk>/next-version/` |
| Pattern | `pieces/<int:pk>/next-version/` |
| Named | true |
