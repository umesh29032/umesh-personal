---
id: url-card-patterns-ai-version-reject
type: url-card
status: generated
owner: generated
scope: route — url:patterns_ai:version-reject
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `version-reject`
...
| Field | Value |
|---|---|
| URL name | `version-reject` |
| Namespace | `patterns_ai` |
| Mount | `/patterns/versions/<int:pk>/reject/` |
| Pattern | `versions/<int:pk>/reject/` |
| Named | true |
