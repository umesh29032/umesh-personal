---
id: url-card-expense-settlement-create
type: url-card
status: generated
owner: generated
scope: route — url:expense:settlement-create
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `settlement-create`
...
| Field | Value |
|---|---|
| URL name | `settlement-create` |
| Namespace | `expense` |
| Mount | `/expense/workers/<int:pk>/settle/` |
| Pattern | `workers/<int:pk>/settle/` |
| Named | true |
...
[Payment (cash)](README.md) (`payment`, via `belongs_to_feature`)
