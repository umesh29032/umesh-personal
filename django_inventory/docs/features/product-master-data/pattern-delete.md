---
id: url-card-production-pattern-delete
type: url-card
status: generated
owner: generated
scope: route — url:production:pattern-delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `pattern-delete`
...
| Field | Value |
|---|---|
| URL name | `pattern-delete` |
| Namespace | `production` |
| Mount | `/production/patterns/<int:pk>/delete/` |
| Pattern | `patterns/<int:pk>/delete/` |
| Named | true |
