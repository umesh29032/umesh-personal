---
id: url-card-production-product-archive
type: url-card
status: generated
owner: generated
scope: route — url:production:product-archive
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `product-archive`
...
| Field | Value |
|---|---|
| URL name | `product-archive` |
| Namespace | `production` |
| Mount | `/production/products/<int:pk>/archive/` |
| Pattern | `products/<int:pk>/archive/` |
| Named | true |
