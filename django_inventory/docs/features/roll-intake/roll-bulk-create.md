---
id: url-card-raw-materials-roll-bulk-create
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:roll-bulk-create
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `roll-bulk-create`
...
| Field | Value |
|---|---|
| URL name | `roll-bulk-create` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/rolls/bulk-add/` |
| Pattern | `rolls/bulk-add/` |
| Named | true |
...
| Field | Value |
|---|---|
| View | `RollBulkCreateView` |
| Module | `raw_materials.views.roll_views` |
| Defined in | `config/raw_materials/views/roll_views.py` |
| Vendor | false |

## App

Derived from the view module (`raw_materials.views.roll_views` → app `raw_materials`; a render rule, not a graph edge).
...
[Roll intake](README.md) (`roll-intake`, via `belongs_to_feature`)
