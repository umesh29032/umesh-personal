---
id: url-card-raw-materials-roll-damage
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:roll-damage
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `roll-damage`
...
| Field | Value |
|---|---|
| URL name | `roll-damage` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/rolls/<int:pk>/damage/` |
| Pattern | `rolls/<int:pk>/damage/` |
| Named | true |
