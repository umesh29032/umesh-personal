---
id: url-card-raw-materials-roll-detail
type: url-card
status: generated
owner: generated
scope: route — url:raw_materials:roll-detail
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `roll-detail`
...
| Field | Value |
|---|---|
| URL name | `roll-detail` |
| Namespace | `raw_materials` |
| Mount | `/raw-materials/rolls/<int:pk>/` |
| Pattern | `rolls/<int:pk>/` |
| Named | true |
