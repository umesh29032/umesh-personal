---
id: url-card-expense-adda-settlement-detail
type: url-card
status: generated
owner: generated
scope: route — url:expense:adda-settlement-detail
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `adda-settlement-detail`
...
| Field | Value |
|---|---|
| URL name | `adda-settlement-detail` |
| Namespace | `expense` |
| Mount | `/expense/settlements/<str:reference>/` |
| Pattern | `settlements/<str:reference>/` |
| Named | true |
...
[Settlement finalize](README.md) (`settlement-finalize`, via `belongs_to_feature`)
