---
id: url-card-expense-adda-settlement-list
type: url-card
status: generated
owner: generated
scope: route — url:expense:adda-settlement-list
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `adda-settlement-list`
...
| Field | Value |
|---|---|
| URL name | `adda-settlement-list` |
| Namespace | `expense` |
| Mount | `/expense/settlements/` |
| Pattern | `settlements/` |
| Named | true |
