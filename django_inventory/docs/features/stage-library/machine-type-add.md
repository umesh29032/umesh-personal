---
id: url-card-production-machine-type-add
type: url-card
status: generated
owner: generated
scope: route — url:production:machine-type-add
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `machine-type-add`
...
| Field | Value |
|---|---|
| URL name | `machine-type-add` |
| Namespace | `production` |
| Mount | `/production/machine-types/add/` |
| Pattern | `machine-types/add/` |
| Named | true |
