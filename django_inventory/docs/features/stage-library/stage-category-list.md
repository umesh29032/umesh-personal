---
id: url-card-production-stage-category-list
type: url-card
status: generated
owner: generated
scope: route — url:production:stage-category-list
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `stage-category-list`
...
| Field | Value |
|---|---|
| URL name | `stage-category-list` |
| Namespace | `production` |
| Mount | `/production/stage-categories/` |
| Pattern | `stage-categories/` |
| Named | true |
