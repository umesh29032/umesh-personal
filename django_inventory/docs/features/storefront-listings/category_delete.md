---
id: url-card-storefront-category-delete
type: url-card
status: generated
owner: generated
scope: route — url:storefront:category_delete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `category_delete`
...
| Field | Value |
|---|---|
| URL name | `category_delete` |
| Namespace | `storefront` |
| Mount | `/storefront/categories/<int:pk>/delete/` |
| Pattern | `categories/<int:pk>/delete/` |
| Named | true |
