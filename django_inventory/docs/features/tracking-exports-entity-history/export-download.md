---
id: url-card-tracking-export-download
type: url-card
status: generated
owner: generated
scope: route — url:tracking:export-download
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `export-download`
...
| Field | Value |
|---|---|
| URL name | `export-download` |
| Namespace | `tracking` |
| Mount | `/tracking/exports/<str:export_code>/download/` |
| Pattern | `exports/<str:export_code>/download/` |
| Named | true |
...
|---|---|
| View | `ReDownloadView` |
| Module | `inventory.views.tracking_exports` |
| Defined in | `config/inventory/views/tracking_exports.py` |
| Vendor | false |

## App

Derived from the view module (`inventory.views.tracking_exports` → app `inventory`; a render rule, not a graph edge).
...
[Tracking exports + entity history (CSV · XLSX · PDF · re-download)](README.md) (`tracking-exports-entity-history`, via `belongs_to_feature`)
