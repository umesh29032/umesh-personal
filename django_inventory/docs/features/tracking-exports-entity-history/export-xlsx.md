---
id: url-card-tracking-export-xlsx
type: url-card
status: generated
owner: generated
scope: route — url:tracking:export-xlsx
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `export-xlsx`
...
| Field | Value |
|---|---|
| URL name | `export-xlsx` |
| Namespace | `tracking` |
| Mount | `/tracking/exports/<str:adda_code>/xlsx/` |
| Pattern | `exports/<str:adda_code>/xlsx/` |
| Named | true |
