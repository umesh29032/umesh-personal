---
id: url-card-tracking-roll-history
type: url-card
status: generated
owner: generated
scope: route — url:tracking:roll-history
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `roll-history`
...
| Field | Value |
|---|---|
| URL name | `roll-history` |
| Namespace | `tracking` |
| Mount | `/tracking/history/roll/<int:roll_pk>/` |
| Pattern | `history/roll/<int:roll_pk>/` |
| Named | true |
