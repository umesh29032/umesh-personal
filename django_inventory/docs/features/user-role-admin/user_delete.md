---
id: url-card-accounts-user-delete
type: url-card
status: generated
owner: generated
scope: route — url:accounts:user_delete
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `user_delete`
...
| Field | Value |
|---|---|
| URL name | `user_delete` |
| Namespace | `accounts` |
| Mount | `/app/users/<int:pk>/delete/` |
| Pattern | `users/<int:pk>/delete/` |
| Named | true |
