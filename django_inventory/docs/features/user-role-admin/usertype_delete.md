---
id: url-card-accounts-usertype-delete
type: url-card
status: generated
owner: generated
scope: route — url:accounts:usertype_delete
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `usertype_delete`
...
| Field | Value |
|---|---|
| URL name | `usertype_delete` |
| Namespace | `accounts` |
| Mount | `/app/user-types/<int:pk>/delete/` |
| Pattern | `user-types/<int:pk>/delete/` |
| Named | true |
