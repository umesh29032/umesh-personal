---
id: url-card-accounts-usertype-edit
type: url-card
status: generated
owner: generated
scope: route — url:accounts:usertype_edit
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `usertype_edit`
...
| Field | Value |
|---|---|
| URL name | `usertype_edit` |
| Namespace | `accounts` |
| Mount | `/app/user-types/<int:pk>/edit/` |
| Pattern | `user-types/<int:pk>/edit/` |
| Named | true |
