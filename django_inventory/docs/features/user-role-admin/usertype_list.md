---
id: url-card-accounts-usertype-list
type: url-card
status: generated
owner: generated
scope: route — url:accounts:usertype_list
anchors: config/config/urls.py
verified: graph:4ed4a2180bcf
---

# URL card — `usertype_list`
...
| Field | Value |
|---|---|
| URL name | `usertype_list` |
| Namespace | `accounts` |
| Mount | `/app/user-types/` |
| Pattern | `user-types/` |
| Named | true |
