---
id: url-card-production-adda-report-review
type: url-card
status: generated
owner: generated
scope: route — url:production:adda-report-review
anchors: config/config/urls.py
verified: graph:5d159ece1df0
---

# URL card — `adda-report-review`
...
| Field | Value |
|---|---|
| URL name | `adda-report-review` |
| Namespace | `production` |
| Mount | `/production/addas/<str:code>/review-reports/` |
| Pattern | `addas/<str:code>/review-reports/` |
| Named | true |
...
[Verify quantity (P1)](README.md) (`verify-quantity`, via `belongs_to_feature`)
