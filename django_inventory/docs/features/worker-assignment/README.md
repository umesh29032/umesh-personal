---
id: feature-worker-assignment
type: feature-doc
status: generated
owner: generated
scope: feature — worker-assignment
...
|---|---|---|
| `production.WorkerStageTask` | `production_workerstagetask` | `service:production.worker_task_service` |
