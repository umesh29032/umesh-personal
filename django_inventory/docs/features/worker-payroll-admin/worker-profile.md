---
id: url-card-expense-worker-profile
type: url-card
status: generated
owner: generated
scope: route — url:expense:worker-profile
anchors: config/config/urls.py
verified: graph:f48dc8b77c29
---

# URL card — `worker-profile`
...
| Field | Value |
|---|---|
| URL name | `worker-profile` |
| Namespace | `expense` |
| Mount | `/expense/workers/<int:pk>/profile/` |
| Pattern | `workers/<int:pk>/profile/` |
| Named | true |
